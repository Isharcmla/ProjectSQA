...
public class DumpArchiveInputStream_ESTest extends DumpArchiveInputStream_ESTest_scaffolding {
  ...
  public void test1()  throws Throwable  {
      ...
      try { 
        DumpArchiveInputStream.matches(byteArray0, 246);
  ...
  public void test2()  throws Throwable  {
      byte[] byteArray0 = new byte[1];
      boolean boolean0 = DumpArchiveInputStream.matches(byteArray0, (-2778));
  ...
  public void test3()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        DumpArchiveInputStream.matches(byteArray0, 1783);
        fail("Expecting exception: ArrayIndexOutOfBoundsException");
