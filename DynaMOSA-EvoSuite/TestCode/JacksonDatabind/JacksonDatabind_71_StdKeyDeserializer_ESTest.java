...
public class StdKeyDeserializer_ESTest extends StdKeyDeserializer_ESTest_scaffolding {
  ...
  public void test02()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("V-R~F", (DeserializationContext) null);
        fail("Expecting exception: NumberFormatException");
      
      } catch(NumberFormatException e) {
         //
         // For input string: \"V-R~F\"
         //
  ...
  public void test05()  throws Throwable  {
      Class<Currency> class0 = Currency.class;
      StdKeyDeserializer.StringKD stdKeyDeserializer_StringKD0 = StdKeyDeserializer.StringKD.forType(class0);
      Object object0 = stdKeyDeserializer_StringKD0.deserializeKey("Failed rehash(): old count=", (DeserializationContext) null);
      assertEquals("Failed rehash(): old count=", object0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Object object0 = stdKeyDeserializer0.deserializeKey("w>C5Nu~W$8Y", (DeserializationContext) null);
  ...
  public void test14()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("VMR~F", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test17()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("J,b^'_J", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test20()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      Locale locale0 = (Locale)stdKeyDeserializer0._parse("Current token (", (DeserializationContext) null);
  ...
  public void test22()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("V-R~F", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test23()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = new StdKeyDeserializer((-829), class0);
      // Undeclared exception!
      try { 
        stdKeyDeserializer0.deserializeKey("3Ov6CO{f", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test24()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("UWrm{@h0O", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test31()  throws Throwable  {
      ...
      StdKeyDeserializer stdKeyDeserializer0 = StdKeyDeserializer.forType(class0);
      try { 
        stdKeyDeserializer0._parse("wF>C5Nu~W$18$Y", (DeserializationContext) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test32()  throws Throwable  {
      ...
      doReturn(stdKeyDeserializer_StringKD0.TYPE_INT).when(jsonDeserializer0).deserialize(any(com.fasterxml.jackson.core.JsonParser.class) , any(com.fasterxml.jackson.databind.DeserializationContext.class));
      ...
      Object object0 = stdKeyDeserializer_DelegatingKD0.deserializeKey("578", defaultDeserializationContext_Impl0);
  ...
  public void test34()  throws Throwable  {
      ...
      StdKeyDeserializer.DelegatingKD stdKeyDeserializer_DelegatingKD0 = new StdKeyDeserializer.DelegatingKD(class0, jsonDeserializer0);
      try { 
        stdKeyDeserializer_DelegatingKD0.deserializeKey("578", defaultDeserializationContext_Impl0);
        fail("Expecting exception: IOException");
      
      } catch(IOException e) {
         //
         // Can not construct Map key of type java.lang.Byte from String (\"578\"): not a valid representation
         //
  ...
  public void test35()  throws Throwable  {
      ...
      DefaultDeserializationContext.Impl defaultDeserializationContext_Impl0 = new DefaultDeserializationContext.Impl(beanDeserializerFactory0);
      try { 
        stdKeyDeserializer_EnumKD0._parse("RNq", defaultDeserializationContext_Impl0);
        fail("Expecting exception: NullPointerException");
