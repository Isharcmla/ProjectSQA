  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unsupported serialization shape (BOOLEAN) for Enum com.fasterxml.jackson.databind.type.ArrayType, not supported as class annotation
         //
         verifyException("com.fasterxml.jackson.databind.ser.std.EnumSerializer", e);
      }
  }
  ...
  public void test11()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Unsupported serialization shape (BOOLEAN) for Enum java.lang.Integer, not supported as property annotation
         //
         verifyException("com.fasterxml.jackson.databind.ser.std.EnumSerializer", e);
      }
  }
