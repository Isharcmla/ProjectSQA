...
public class TypeFactory_ESTest extends TypeFactory_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      TypeFactory typeFactory0 = TypeFactory.instance;
      try { 
        typeFactory0.findClass("kon_y]$>g?uU.yO");
        fail("Expecting exception: ClassNotFoundException");
      
      } catch(ClassNotFoundException e) {
         //
         // Class 'kon_y]$>g?uU/yO.class' should be in target project, but could not be found!
         //
  ...
  public void test16()  throws Throwable  {
      ...
      try { 
        typeFactory1.findClass("Unrecognized primitive type: ");
        fail("Expecting exception: ClassNotFoundException");
  ...
  public void test25()  throws Throwable  {
      TypeFactory typeFactory0 = TypeFactory.instance;
      try { 
        typeFactory0.findClass("Unrecognized primitive type: ");
        fail("Expecting exception: ClassNotFoundException");
      
      } catch(ClassNotFoundException e) {
         //
         // Class 'Unrecognized primitive type: .class' should be in target project, but could not be found!
         //
         verifyException("com.fasterxml.jackson.databind.type.TypeFactory", e);
      }
  }
  ...
  public void test39()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalArgumentException");
         ...
         //
         // Class com.fasterxml.jackson.databind.type.ReferenceType not a super-type of [simple type, class java.lang.Object]
         //
         verifyException("com.fasterxml.jackson.databind.type.TypeFactory", e);
      }
  }
  ...
  public void test51()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        typeFactory1.constructSpecializedType(javaType0, class2);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Class com.fasterxml.jackson.databind.SerializationFeature not subtype of [simple type, class com.fasterxml.jackson.databind.JsonDeserializer]
         //
         verifyException("com.fasterxml.jackson.databind.type.TypeFactory", e);
      }
  }
  ...
  public void test52()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // TypeModifier null (of type com.fasterxml.jackson.databind.type.TypeModifier$MockitoMock$1975572857) return null for type [collection type; class java.util.AbstractSequentialList, contains [simple type, class java.lang.Object]]
         //
         verifyException("com.fasterxml.jackson.databind.type.TypeFactory", e);
      }
  }
  ...
  public void test53()  throws Throwable  {
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // TypeModifier null (of type com.fasterxml.jackson.databind.type.TypeModifier$MockitoMock$1975572857) return null for type [simple type, class java.lang.Object]
         //
         verifyException("com.fasterxml.jackson.databind.type.TypeFactory", e);
      }
  }
  ...
  public void test55()  throws Throwable  {
      ...
      TreeSet<CollectionLikeType> treeSet0 = new TreeSet<CollectionLikeType>();
      try { 
        objectMapper0.convertValue((Object) treeSet0, (Class<HashMap<Object, Enum>>) class0);
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // Can not construct instance of com.fasterxml.jackson.databind.deser.SettableBeanProperty: abstract types either need to be mapped to concrete types, have custom deserializer, or contain additional type information
         //  at [Source: java.lang.String@0000000899; line: -1, column: -1]
         //
