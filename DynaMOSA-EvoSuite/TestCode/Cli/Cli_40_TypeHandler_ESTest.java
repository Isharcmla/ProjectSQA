...
public class TypeHandler_ESTest extends TypeHandler_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      try { 
        TypeHandler.createClass("2HaS|&<ani");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find the class: 2HaS|&<ani
         //
  ...
  public void test02()  throws Throwable  {
      try { 
        TypeHandler.openFile("slR30uY%C*7?_;dQtss");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to find file: slR30uY%C*7?_;dQtss
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test03()  throws Throwable  {
      ...
      try { 
        TypeHandler.createFiles("|l=jB=@h%");
  ...
  public void test05()  throws Throwable  {
      try { 
        TypeHandler.createURL("l$D?h,qfea8");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Unable to parse the URL: l$D?h,qfea8
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      File file0 = TypeHandler.createFile("xRE");
  ...
  public void test10()  throws Throwable  {
      try { 
        TypeHandler.createNumber("Cf]{0Yz");
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // For input string: \"Cf]{0Yz\"
         //
         verifyException("org.apache.commons.cli.TypeHandler", e);
      }
  }
