...
public class JsonReader_ESTest extends JsonReader_ESTest_scaffolding {
  ...
  public void test06()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[\"$#}ww r\"M");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.beginArray();
      // Undeclared exception!
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Expected END_ARRAY but was STRING at line 1 column 3 path $[0]
         //
         verifyException("com.google.gson.stream.JsonReader", e);
      }
  }
  ...
  public void test07()  throws Throwable  {
      StringReader stringReader0 = new StringReader("gm+Q>|l");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test08()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[\"#}ww\"M");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      // Undeclared exception!
      try { 
        jsonReader0.beginObject();
  ...
  public void test10()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[\"$#}Ww r#S\"M");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test11()  throws Throwable  {
      StringReader stringReader0 = new StringReader("{(6jeAV8!d");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test12()  throws Throwable  {
      StringReader stringReader0 = new StringReader("U$$5clUA^ZM$XwK");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test18()  throws Throwable  {
      StringReader stringReader0 = new StringReader("t R[G.D&$T5F");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test21()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[$#ww r\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test26()  throws Throwable  {
      StringReader stringReader0 = new StringReader("y[jCr;d'c]-qY");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      stringReader0.read();
      jsonReader0.skipValue();
  ...
  public void test27()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\"$}w r\"M");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.peeked = 1;
      try { 
        jsonReader0.skipValue();
  ...
  public void test30()  throws Throwable  {
      StringReader stringReader0 = new StringReader("com.gogle.gson.stream.MalformedJsonException");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      stringReader0.reset();
      ...
      try { 
        ...
        fail("Expecting exception: IllegalStateException");
         ...
         //
         // Expected a long but was STRING at line 1 column 45 path $
         //
         verifyException("com.google.gson.stream.JsonReader", e);
      }
  }
  ...
  public void test33()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[]tF4Q");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.skipValue();
      assertFalse(jsonReader0.isLenient());
  }
  ...
  public void test35()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[:<J131Bs");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.skipValue();
        fail("Expecting exception: IOException");
  ...
  public void test36()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Tw>n");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test37()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[F#ww r\"");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      try { 
        jsonReader0.skipValue();
        fail("Expecting exception: IOException");
  ...
  public void test38()  throws Throwable  {
      StringReader stringReader0 = new StringReader("n^kQKxdCFOLa.aAJ");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test41()  throws Throwable  {
      StringReader stringReader0 = new StringReader("1+|k=1 j7x9v");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.nextString();
      try { 
  ...
  public void test42()  throws Throwable  {
      StringReader stringReader0 = new StringReader("-,Tzj9>%bWe");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      boolean boolean0 = jsonReader0.hasNext();
      assertTrue(boolean0);
  ...
  public void test44()  throws Throwable  {
      StringReader stringReader0 = new StringReader("('RWt0eVaY0");
  ...
  public void test45()  throws Throwable  {
      StringReader stringReader0 = new StringReader(".~>Y5*$V");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test46()  throws Throwable  {
      StringReader stringReader0 = new StringReader("E-9UQ[0?/");
      stringReader0.read();
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      assertFalse(jsonReader0.isLenient());
      ...
      assertEquals("-9UQ", string0);
  }

  @Test(timeout = 4000)
  public void test47()  throws Throwable  {
      StringReader stringReader0 = new StringReader("eA>OL!089^6Y%+CMS");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
  ...
  public void test49()  throws Throwable  {
      StringReader stringReader0 = new StringReader("-[C;;t'c]-GY");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test61()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\" F$-M&WBpt!|U#;");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.nextDouble();
  ...
  public void test62()  throws Throwable  {
      StringReader stringReader0 = new StringReader("w;Q9");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test66()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\" F$-M&WBptK|U#r");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.nextLong();
  ...
  public void test70()  throws Throwable  {
      StringReader stringReader0 = new StringReader("Zs,bEB|V>mj");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      assertFalse(jsonReader0.isLenient());
  ...
  public void test71()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/^Ck?J39");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      String string0 = jsonReader0.nextString();
      assertEquals("", string0);
  ...
  public void test72()  throws Throwable  {
      StringReader stringReader0 = new StringReader("dg87\"::>i@>9~K");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      String string0 = jsonReader0.nextString();
      assertEquals("dg87\"", string0);
  }
  ...
  public void test73()  throws Throwable  {
      ...
      jsonReader0.setLenient(true);
      String string0 = jsonReader0.nextString();
      assertEquals("('RWt0eVaY0", string0);
  }

  @Test(timeout = 4000)
  public void test74()  throws Throwable  {
      StringReader stringReader0 = new StringReader("$N|x^n]FECydXI");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test75()  throws Throwable  {
      StringReader stringReader0 = new StringReader("co{.googl^.gson.stream.JsonReade.");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test76()  throws Throwable  {
      StringReader stringReader0 = new StringReader("7o}VULyVw?L.'1");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      // Undeclared exception!
      try { 
  ...
  public void test79()  throws Throwable  {
      StringReader stringReader0 = new StringReader("%\"\"A3B),6[kAIHdw");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test80()  throws Throwable  {
      StringReader stringReader0 = new StringReader("/^CkoJ_9");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test81()  throws Throwable  {
      StringReader stringReader0 = new StringReader("O:)^cN:T'");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test84()  throws Throwable  {
      StringReader stringReader0 = new StringReader("iW?ZwFH{w,z!X");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test85()  throws Throwable  {
      StringReader stringReader0 = new StringReader("JItk4RaJo}+'B80)C");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      jsonReader0.skipValue();
      assertTrue(jsonReader0.isLenient());
  ...
  public void test90()  throws Throwable  {
      StringReader stringReader0 = new StringReader("\"#fwwM");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.setLenient(true);
      try { 
        jsonReader0.nextInt();
  ...
  public void test93()  throws Throwable  {
      StringReader stringReader0 = new StringReader("[\"$#h)w rS!M");
      JsonReader jsonReader0 = new JsonReader(stringReader0);
      jsonReader0.peeked = 16;
      jsonReader0.skipValue();
      assertFalse(jsonReader0.isLenient());
