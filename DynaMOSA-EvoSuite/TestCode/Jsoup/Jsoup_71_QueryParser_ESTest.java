...
public class QueryParser_ESTest extends QueryParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("WH*,nSB~I");
  ...
  public void test04()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("lJ*n|67~#d");
      assertNotNull(evaluator0);
  }
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        QueryParser.parse("jL.H0V!@q");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Could not parse query 'jL.H0V!@q': unexpected token at '!@q'
         //
         verifyException("org.jsoup.select.QueryParser", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        QueryParser.parse(",BXyY0,j;Cw[]9-P");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Could not parse query 'j;Cw[]9-P': unexpected token at ';Cw[]9-P'
         //
         verifyException("org.jsoup.select.QueryParser", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      // Undeclared exception!
      try { 
        QueryParser.parse("dpbmB2O+Rs*7P~");
        fail("Expecting exception: IllegalStateException");
  ...
  public void test11()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("*|no,t");
      assertNotNull(evaluator0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("R~Qh81>nlLX");
      assertNotNull(evaluator0);
  }
  ...
  public void test13()  throws Throwable  {
      // Undeclared exception!
      try { 
        QueryParser.parse(">(DLtV>{ QE,_ZsZ");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Did not find balanced marker at 'DLtV>{ QE,_ZsZ'
         //
         verifyException("org.jsoup.select.QueryParser", e);
      }
  }
  ...
  public void test32()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("[SL|iGP]CH");
      assertNotNull(evaluator0);
  }

  @Test(timeout = 4000)
  public void test33()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("[L%s!: =%F]");
      assertNotNull(evaluator0);
  }
  ...
  public void test37()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("[%Bs*=Bn]");
      assertNotNull(evaluator0);
  }
}
