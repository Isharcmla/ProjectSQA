...
public class QueryParser_ESTest extends QueryParser_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      // Undeclared exception!
      try { 
        QueryParser.parse("*9:o-'SN9t RcDG");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Could not parse query '*9:o-'SN9t RcDG': unexpected token at ':o-'SN9t RcDG'
         //
  ...
  public void test04()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("aZ#l9,u");
  ...
  public void test06()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse(":has(el) subsalct must no6 be mpty");
      assertNotNull(evaluator0);
  }
  ...
  public void test07()  throws Throwable  {
      // Undeclared exception!
      try { 
        QueryParser.parse("pH.X(/[%9Bf");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Could not parse query 'pH.X(/[%9Bf': unexpected token at '(/[%9Bf'
         //
         verifyException("org.jsoup.select.QueryParser", e);
      }
  }
  ...
  public void test09()  throws Throwable  {
      // Undeclared exception!
      try { 
        QueryParser.parse("+6VX Q5%e.L~+G3M");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Could not parse query 'Q5%e.L': unexpected token at '%e.L'
         //
         verifyException("org.jsoup.select.QueryParser", e);
      }
  }
  ...
  public void test10()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse(">35[T");
      assertNotNull(evaluator0);
  }

  @Test(timeout = 4000)
  public void test11()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("*|m4,k");
      assertNotNull(evaluator0);
  }

  @Test(timeout = 4000)
  public void test12()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("T,T Y0");
      assertNotNull(evaluator0);
  }
  ...
  public void test14()  throws Throwable  {
      // Undeclared exception!
      try { 
        QueryParser.parse("q+j(kqQ4");
        fail("Expecting exception: IllegalStateException");
      
      } catch(IllegalStateException e) {
         //
         // Could not parse query 'j(kqQ4)': unexpected token at 'j(kqQ4)'
         //
         verifyException("org.jsoup.select.QueryParser", e);
      }
  }
  ...
  public void test31()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("e|yA");
      assertNotNull(evaluator0);
  }
  ...
  public void test34()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("[%8js)=%s");
      assertNotNull(evaluator0);
  }

  @Test(timeout = 4000)
  public void test35()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("[[|0xs~!=%!");
      assertNotNull(evaluator0);
  }

  @Test(timeout = 4000)
  public void test36()  throws Throwable  {
      Evaluator evaluator0 = QueryParser.parse("[%Xjs^=%s]");
      assertNotNull(evaluator0);
  }
