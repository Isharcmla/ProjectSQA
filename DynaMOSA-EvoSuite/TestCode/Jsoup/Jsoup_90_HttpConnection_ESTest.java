...
public class HttpConnection_ESTest extends HttpConnection_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "org.jsoup.select.structuralevaluator$previoussibling");
  ...
  public void test12()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.proxy("Ez", 7);
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test13()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.userAgent("org.jsoup.examples.HtmlToPlainText$FormattingVisitor");
      assertSame(httpConnection0, connection0);
  }
  ...
  public void test22()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("Content-Encoding", "rn(&&to[0coa4+od3c", (InputStream) null);
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test28()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      Connection connection0 = httpConnection0.data("org.jsoup.parser.Token$StartTag", "Content-Encoding", (InputStream) null, "Content-Encoding");
      assertSame(connection0, httpConnection0);
  }
  ...
  public void test29()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      EvoSuiteURL evoSuiteURL0 = new EvoSuiteURL("http://www.someFakeButWellFormedURL.org/fooExample");
      NetworkHandling.createRemoteTextFile(evoSuiteURL0, "9C");
      httpConnection_Request0.url = uRL0;
      HttpConnection.Response httpConnection_Response0 = HttpConnection.Response.execute(httpConnection_Request0);
  ...
  public void test35()  throws Throwable  {
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("@0dQ(g>uiKtt~go", "Content-Encoding");
      httpConnection_KeyVal0.contentType();
      assertEquals("@0dQ(g>uiKtt~go", httpConnection_KeyVal0.key());
  ...
  public void test37()  throws Throwable  {
      ...
      hashMap0.put("Content-Encoding", "F:CA<kb");
  ...
  public void test40()  throws Throwable  {
      HttpConnection httpConnection0 = new HttpConnection();
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("multipart/form-data", "&U`Eu00t(g");
      List<Connection.KeyVal> list0 = List.of((Connection.KeyVal) httpConnection_KeyVal0, (Connection.KeyVal) httpConnection_KeyVal0, (Connection.KeyVal) httpConnection_KeyVal0);
  ...
  public void test43()  throws Throwable  {
      ...
      List<String> list0 = List.of("application/x-www-form-urlencoded", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36", "application/x-www-form-urlencoded", "Content-Type");
  ...
  public void test47()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        httpConnection_Request0.maxBodySize((-2671));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test50()  throws Throwable  {
      ...
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create(":v:u&,j6!<o-)`?$$", ":v:u&,j6!<o-)`?$$");
  ...
  public void test51()  throws Throwable  {
      HttpConnection.Request httpConnection_Request0 = new HttpConnection.Request();
      URL uRL0 = MockURL.getHttpExample();
      httpConnection_Request0.requestBody("LAIp4D/2-R)q&2dGw");
      Connection.Method connection_Method0 = Connection.Method.PATCH;
      httpConnection_Request0.method = connection_Method0;
      httpConnection_Request0.url = uRL0;
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("_https", "_https");
      httpConnection_Request0.data((Connection.KeyVal) httpConnection_KeyVal0);
      try { 
        HttpConnection.Response.execute(httpConnection_Request0);
  ...
  public void test55()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection_Request0.url = uRL0;
      HttpConnection.Request httpConnection_Request1 = httpConnection_Request0.proxy("Content-Type", 381);
      try { 
  ...
  public void test57()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      List<String> list0 = List.of("Content-Encoding", "multipart/form-data", "Content-Type", "application/x-www-form-urlencoded");
  ...
  public void test58()  throws Throwable  {
      HttpConnection.Response httpConnection_Response0 = new HttpConnection.Response();
      HashMap<String, List<String>> hashMap0 = new HashMap<String, List<String>>();
      List<String> list0 = List.of("%k740X", "application/x-www-form-urlencoded", "", "i E=v?mb~2}\"W");
      hashMap0.put("Set-Cookie", list0);
      httpConnection_Response0.processResponseHeaders(hashMap0);
  ...
  public void test60()  throws Throwable  {
      ...
      URL uRL0 = MockURL.getHttpExample();
      httpConnection_Request0.url = uRL0;
      HttpConnection.KeyVal httpConnection_KeyVal0 = HttpConnection.KeyVal.create("p/\"gd)", "p/\"gd)");
      httpConnection_Request0.data((Connection.KeyVal) httpConnection_KeyVal0);
      httpConnection_Request0.data((Connection.KeyVal) httpConnection_KeyVal0);
      try { 
        HttpConnection.Response.execute(httpConnection_Request0);
