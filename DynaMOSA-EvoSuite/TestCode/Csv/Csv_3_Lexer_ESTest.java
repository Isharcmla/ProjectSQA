...
public class Lexer_ESTest extends Lexer_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("\"jM[x\"Kn,h");
  ...
  public void test04()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      StringReader stringReader0 = new StringReader("r1Wvw=Vc JK");
      ExtendedBufferedReader extendedBufferedReader0 = new ExtendedBufferedReader(stringReader0);
      CSVLexer cSVLexer0 = new CSVLexer(cSVFormat0, extendedBufferedReader0);
      int int0 = cSVLexer0.readEscape();
  ...
  public void test06()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("q0b)");
      ExtendedBufferedReader extendedBufferedReader0 = new ExtendedBufferedReader(stringReader0);
      CSVLexer cSVLexer0 = new CSVLexer(cSVFormat0, extendedBufferedReader0);
      int int0 = cSVLexer0.readEscape();
  ...
  public void test08()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.DEFAULT;
      StringBuilder stringBuilder0 = new StringBuilder("(line ");
      Reader reader0 = Reader.nullReader();
      ExtendedBufferedReader extendedBufferedReader0 = new ExtendedBufferedReader(reader0);
      CSVLexer cSVLexer0 = new CSVLexer(cSVFormat0, extendedBufferedReader0);
      cSVLexer0.trimTrailingSpaces(stringBuilder0);
      assertEquals("(line", stringBuilder0.toString());
  }
  ...
  public void test11()  throws Throwable  {
      ...
      StringReader stringReader0 = new StringReader("S$F4MIg`IJKbdN#");
      ExtendedBufferedReader extendedBufferedReader0 = new ExtendedBufferedReader(stringReader0);
      CSVLexer cSVLexer0 = new CSVLexer(cSVFormat0, extendedBufferedReader0);
  ...
  public void test12()  throws Throwable  {
      ...
      boolean boolean0 = cSVLexer0.isWhitespace(30);
      assertTrue(boolean0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      ExtendedBufferedReader extendedBufferedReader0 = new ExtendedBufferedReader(stringReader0);
      CSVLexer cSVLexer0 = new CSVLexer(cSVFormat0, extendedBufferedReader0);
      boolean boolean0 = cSVLexer0.isStartOfLine(69);
      assertFalse(boolean0);
  }
  ...
  public void test15()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.MYSQL;
      Token token0 = new Token();
      StringReader stringReader0 = new StringReader("4KQM");
      ExtendedBufferedReader extendedBufferedReader0 = new ExtendedBufferedReader(stringReader0);
      CSVLexer cSVLexer0 = new CSVLexer(cSVFormat0, extendedBufferedReader0);
      Token token1 = cSVLexer0.nextToken(token0);
      assertSame(token0, token1);
  ...
  public void test16()  throws Throwable  {
      CSVFormat cSVFormat0 = CSVFormat.EXCEL;
      StringReader stringReader0 = new StringReader(":,0z~|S(C,<h");
      ExtendedBufferedReader extendedBufferedReader0 = new ExtendedBufferedReader(stringReader0);
      CSVLexer cSVLexer0 = new CSVLexer(cSVFormat0, extendedBufferedReader0);
      Token token0 = new Token();
      Token token1 = cSVLexer0.nextToken(token0);
