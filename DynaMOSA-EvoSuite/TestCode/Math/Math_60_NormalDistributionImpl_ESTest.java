...
public class NormalDistributionImpl_ESTest extends NormalDistributionImpl_ESTest_scaffolding {
  ...
  public void test4()  throws Throwable  {
      NormalDistributionImpl normalDistributionImpl0 = new NormalDistributionImpl();
      double double0 = normalDistributionImpl0.inverseCumulativeProbability(0.8397555272214521);
      assertEquals(0.9934536128809806, double0, 0.01);
  }
  ...
  public void test5()  throws Throwable  {
      ...
      try {
        normalDistributionImpl0 = new NormalDistributionImpl((-1288.5449355), (-1288.5449355), (-1288.5449355));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // -1,288.545 is smaller than, or equal to, the minimum (0): standard deviation (-1,288.545)
         //
