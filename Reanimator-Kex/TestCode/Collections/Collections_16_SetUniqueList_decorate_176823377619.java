...
public class SetUniqueList_decorate_176823377619 {
    ...
    public void setup() throws Throwable {
        ...
        ((LinkedList) term224).add(term226);
        ((LinkedList) term224).add(term228);
        ((LinkedList) term224).add((Object)null);
        ((LinkedList) term224).add((Object)null);
        HashMap term210 = new HashMap();
        Set<Object> term231 =  ((Map) term210).keySet();
        HashSet term209 = new HashSet((Collection<? extends Object>) term231);
        ...
        ((LinkedList) term98).add((Object)null);
        term208 = newInstance(Class.forName("org.apache.commons.collections.list.SetUniqueList"));
        setField(term208, term208.getClass(), "set", term209);
        setField(term208, term208.getClass(), "collection", term98);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term1, term224));
        assertTrue(recursiveEquals(retValue, term208));
    }
