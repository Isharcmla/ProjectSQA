...
public class AbstractPatriciaTrie_removeEntry_68174078419 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractPatriciaTrie_removeEntry_68174078419() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        callMethod(klass, "removeEntry", argTypes, null, args);
    }
