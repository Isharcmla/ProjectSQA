...
public class HelpFormatter_printHelp_20000580158 {
    ...
    public void setup() throws Throwable {
        ...
        term15578 = newInstance(Class.forName("org.apache.commons.cli.HelpFormatter"));
        Object term15589 = newInstance(Class.forName("org.apache.commons.cli.HelpFormatter$OptionComparator"));
        setIntField(term15578, term15578.getClass(), "defaultWidth", 74);
        setIntField(term15578, term15578.getClass(), "defaultLeftPad", 1);
        setIntField(term15578, term15578.getClass(), "defaultDescPad", 3);
        setField(term15578, term15578.getClass(), "defaultSyntaxPrefix", "usage: ");
        setField(term15578, term15578.getClass(), "defaultNewLine", "\n");
        setField(term15578, term15578.getClass(), "defaultOptPrefix", "-");
        setField(term15578, term15578.getClass(), "defaultLongOptPrefix", "--");
        setField(term15578, term15578.getClass(), "defaultArgName", "arg");
        setField(term15578, term15578.getClass(), "optionComparator", term15589);
        HashMap term15593 = new HashMap();
        HashMap term15595 = new HashMap();
        ArrayList term15596 = new ArrayList();
        HashMap term15598 = new HashMap();
        term15592 = newInstance(Class.forName("org.apache.commons.cli.Options"));
        setField(term15592, term15592.getClass(), "shortOpts", term15593);
        setField(term15592, term15592.getClass(), "longOpts", term15595);
        setField(term15592, term15592.getClass(), "requiredOpts", term15596);
        setField(term15592, term15592.getClass(), "optionGroups", term15598);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term891, term15578));
        assertTrue(recursiveEquals(term932, term15592));
    }
