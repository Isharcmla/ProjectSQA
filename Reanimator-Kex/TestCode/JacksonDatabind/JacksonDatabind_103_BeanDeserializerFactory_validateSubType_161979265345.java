...
public class BeanDeserializerFactory_validateSubType_161979265345 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_validateSubType_161979265345() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "_validateSubType", argTypes, null, args);
            assertTrue(false);
        }
