...
public class BaseSettings_withClassIntrospector_153598732827 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BaseSettings_withClassIntrospector_153598732827() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "withClassIntrospector", argTypes, null, args);
            assertTrue(false);
        }
