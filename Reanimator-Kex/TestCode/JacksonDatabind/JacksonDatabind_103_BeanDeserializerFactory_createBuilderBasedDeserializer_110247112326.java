...
public class BeanDeserializerFactory_createBuilderBasedDeserializer_110247112326 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_createBuilderBasedDeserializer_110247112326() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[3] = null;
        try {
            callMethod(klass, "createBuilderBasedDeserializer", argTypes, null, args);
            assertTrue(false);
        }
