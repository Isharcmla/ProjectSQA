...
public class BeanDeserializerBase_wrapAndThrow_175095530894 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term214 = Class.forName((String) "java.nio.channels.GatheringByteChannel");
        Class<? extends Object> term217 = Class.forName((String) "java.io.FilterWriter");
        Class<? extends Object> term219 = Class.forName((String) "java.io.ObjectStreamException");
        Class<? extends Object> term223 = Class.forName((String) "java.lang.invoke.VarHandleInts$FieldStaticReadOnly");
        Class<? extends Object> term228 = Class.forName((String) "java.nio.ByteBufferAsLongBufferL");
        Class<? extends Object> term232 = Class.forName((String) "java.nio.Buffer$1");
        Class<? extends Object> term236 = Class.forName((String) "java.util.stream.Nodes");
        Class<? extends Object> term240 = Class.forName((String) "org.vorpal.research.kex.intrinsics.AssertIntrinsics");
        Class<? extends Object> term244 = Class.forName((String) "java.util.concurrent.SubmissionPublisher$ConsumerTask");
        Class<? extends Object> term248 = Class.forName((String) "com.fasterxml.jackson.databind.introspect.TypeResolutionContext$Basic");
        Class<? extends Object> term252 = Class.forName((String) "java.util.concurrent.Flow$Subscription");
        Class<? extends Object> term256 = Class.forName((String) "java.util.stream.LongStream");
        Class<? extends Object> term260 = Class.forName((String) "kex.java.util.Arrays");
        Class<? extends Object> term264 = Class.forName((String) "java.util.LinkedList$ListItr");
        Class<? extends Object> term266 = Class.forName((String) "java.lang.invoke.VolatileCallSite");
        Class<? extends Object> term269 = Class.forName((String) "java.util.concurrent.atomic.AtomicLongFieldUpdater$CASUpdater");
        Class<? extends Object> term271 = Class.forName((String) "com.fasterxml.jackson.databind.deser.std.ContainerDeserializerBase");
        Class<? extends Object> term273 = Class.forName((String) "java.util.zip.ZipFile$ZipFileInputStream");
        Class<? extends Object> term376 = Class.forName((String) "java.util.CollSer");
        Class<? extends Object> term378 = Class.forName((String) "kex.java.util.HashMap$Node");
        ...
        setShortElement(term147, 25, (short) 9);
        ...
        setLongElement(term275, 4, 131202531099536L);
        setLongElement(term275, 5, 34364440080L);
        setLongElement(term275, 6, 131202531166688L);
        setLongElement(term275, 7, 131202530692736L);
        setLongElement(term275, 8, 131202530692624L);
        setLongElement(term275, 9, 131202530692768L);
        setLongElement(term275, 10, 131202531053120L);
        setLongElement(term275, 11, 34363766248L);
        setLongElement(term275, 12, 34363766248L);
        setLongElement(term275, 13, 131199477050448L);
        setLongElement(term275, 14, 131199477050448L);
        setLongElement(term275, 15, 131199477050304L);
        setLongElement(term275, 16, 131199477094864L);
        setLongElement(term275, 17, 131199477096512L);
        setLongElement(term275, 18, 131199477097280L);
        setLongElement(term275, 19, 131199474021968L);
        setLongElement(term275, 20, 34363739368L);
        setLongElement(term275, 21, 34363739368L);
        setLongElement(term275, 22, 131199477048944L);
        setLongElement(term275, 23, 34363829248L);
        setLongElement(term275, 24, 131199474021968L);
        setLongElement(term275, 25, 131202527864080L);
