...
public class BasicDeserializerFactory_findCustomReferenceDeserializer_735334315101 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_findCustomReferenceDeserializer_735334315101() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.fasterxml.jackson.databind.type.ReferenceType");
        ...
        args[4] = null;
        try {
            callMethod(klass, "_findCustomReferenceDeserializer", argTypes, null, args);
            assertTrue(false);
        }
