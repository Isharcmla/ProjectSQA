...
public class StdDeserializer_findContentNullStyle_1587710974110 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public StdDeserializer_findContentNullStyle_1587710974110() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "findContentNullStyle", argTypes, null, args);
            assertTrue(false);
        }
