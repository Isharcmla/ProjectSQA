...
public class StdDelegatingSerializer_withDelegate_171653277019 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public StdDelegatingSerializer_withDelegate_171653277019() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "withDelegate", argTypes, null, args);
            assertTrue(false);
        }
