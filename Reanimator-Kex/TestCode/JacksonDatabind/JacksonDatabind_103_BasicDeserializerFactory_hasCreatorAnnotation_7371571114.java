...
public class BasicDeserializerFactory_hasCreatorAnnotation_7371571114 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_hasCreatorAnnotation_7371571114() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "_hasCreatorAnnotation", argTypes, null, args);
            assertTrue(false);
        }
