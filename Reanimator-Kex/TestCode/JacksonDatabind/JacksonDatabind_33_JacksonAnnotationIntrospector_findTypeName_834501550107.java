...
public class JacksonAnnotationIntrospector_findTypeName_834501550107 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_findTypeName_834501550107() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "findTypeName", argTypes, null, args);
            assertTrue(false);
        }
