...
public class BasicSerializerFactory_findConverter_156571582749 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicSerializerFactory_findConverter_156571582749() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "findConverter", argTypes, null, args);
            assertTrue(false);
        }
