...
public class StdDeserializer_verifyNumberForScalarCoercion_1045890759100 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public StdDeserializer_verifyNumberForScalarCoercion_1045890759100() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "_verifyNumberForScalarCoercion", argTypes, null, args);
            assertTrue(false);
        }
