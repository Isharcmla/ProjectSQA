...
public class ObjectIdReferenceProperty_withName_62420030317 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ObjectIdReferenceProperty_withName_62420030317() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "withName", argTypes, null, args);
            assertTrue(false);
        }
