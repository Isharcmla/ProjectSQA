...
public class BeanDeserializerFactory_addBackReferenceProperties_18242856837 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_addBackReferenceProperties_18242856837() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "addBackReferenceProperties", argTypes, null, args);
            assertTrue(false);
        }
