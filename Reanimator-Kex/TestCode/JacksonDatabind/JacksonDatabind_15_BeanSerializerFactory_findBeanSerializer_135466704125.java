...
public class BeanSerializerFactory_findBeanSerializer_135466704125 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanSerializerFactory_findBeanSerializer_135466704125() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "findBeanSerializer", argTypes, null, args);
            assertTrue(false);
        }
