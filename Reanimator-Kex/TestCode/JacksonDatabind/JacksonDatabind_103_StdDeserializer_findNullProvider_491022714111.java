...
public class StdDeserializer_findNullProvider_491022714111 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public StdDeserializer_findNullProvider_491022714111() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[2] = Class.forName("com.fasterxml.jackson.annotation.Nulls");
        ...
        args[3] = null;
        try {
            callMethod(klass, "_findNullProvider", argTypes, null, args);
            assertTrue(false);
        }
