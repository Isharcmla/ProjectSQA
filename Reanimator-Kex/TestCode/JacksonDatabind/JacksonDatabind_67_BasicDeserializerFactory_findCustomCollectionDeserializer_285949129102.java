...
public class BasicDeserializerFactory_findCustomCollectionDeserializer_285949129102 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_findCustomCollectionDeserializer_285949129102() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.fasterxml.jackson.databind.type.CollectionType");
        ...
        args[4] = null;
        try {
            callMethod(klass, "_findCustomCollectionDeserializer", argTypes, null, args);
            assertTrue(false);
        }
