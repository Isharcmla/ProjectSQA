...
public class ObjectMapper_canSerialize_1356986750105 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term419;

    public ObjectMapper_canSerialize_1356986750105() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term489 = Class.forName((String) "com.fasterxml.jackson.databind.ser.impl.JsonSerializerMap$Bucket");
        Class<? extends Object> term491 = Class.forName((String) "com.fasterxml.jackson.annotation.JsonRawValue");
        Class<? extends Object> term493 = Class.forName((String) "java.nio.Buffer");
        Class<? extends Object> term495 = Class.forName((String) "java.lang.Runtime$Version");
        Class<? extends Object> term497 = Class.forName((String) "com.fasterxml.jackson.databind.ser.impl.PropertySerializerMap$Multi");
        Class<? extends Object> term499 = Class.forName((String) "java.util.concurrent.SynchronousQueue");
        Class<? extends Object> term501 = Class.forName((String) "java.nio.channels.spi.AbstractInterruptibleChannel$1");
        Class<? extends Object> term503 = Class.forName((String) "java.util.EnumSet$SerializationProxy");
        Class<? extends Object> term505 = Class.forName((String) "java.util.stream.ForEachOps$ForEachOp$OfInt");
        Class<? extends Object> term507 = Class.forName((String) "com.fasterxml.jackson.annotation.JsonFilter");
        Class<? extends Object> term509 = Class.forName((String) "com.fasterxml.jackson.databind.deser.std.PrimitiveArrayDeserializers$LongDeser");
        Class<? extends Object> term511 = Class.forName((String) "com.fasterxml.jackson.databind.ser.std.StdJdkSerializers$AtomicBooleanSerializer");
        Class<? extends Object> term513 = Class.forName((String) "java.util.stream.ReferencePipeline$8$1");
        Class<? extends Object> term515 = Class.forName((String) "java.util.stream.SpinedBuffer$OfPrimitive");
        Class<? extends Object> term517 = Class.forName((String) "java.util.concurrent.CompletionService");
        ...
        setShortElement(term422, 16, (short) 5);
        setShortElement(term422, 17, (short) 6);
        ...
        setLongElement(term519, 4, 138852941654208L);
        setLongElement(term519, 5, 34364440080L);
        setLongElement(term519, 6, 138852941728640L);
        setLongElement(term519, 7, 138852941262768L);
        setLongElement(term519, 8, 138852941262656L);
        setLongElement(term519, 9, 138852941262800L);
        setLongElement(term519, 10, 138852941615088L);
        setLongElement(term519, 11, 34363766248L);
        setLongElement(term519, 12, 138852941612608L);
        setLongElement(term519, 13, 138852941615088L);
        setLongElement(term519, 14, 34363766248L);
        setLongElement(term519, 15, 34363766248L);
        setLongElement(term519, 16, 138849882293360L);
        setLongElement(term519, 17, 138849882293360L);
        setLongElement(term519, 18, 138849882293216L);
        setLongElement(term519, 19, 138849882297520L);
        setLongElement(term519, 20, 138849882299168L);
        setLongElement(term519, 21, 138849882299936L);
        setLongElement(term519, 22, 138849879226352L);
        setLongElement(term519, 23, 34363739368L);
        setLongElement(term519, 24, 34363739368L);
        setLongElement(term519, 25, 138849882139136L);
        setLongElement(term519, 26, 34363829248L);
        setLongElement(term519, 27, 138849879226352L);
        setLongElement(term519, 28, 138852938181440L);
