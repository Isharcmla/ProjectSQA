...
public class BeanDeserializerFactory_createBeanDeserializer_160277662923 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_createBeanDeserializer_160277662923() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "createBeanDeserializer", argTypes, null, args);
            assertTrue(false);
        }
