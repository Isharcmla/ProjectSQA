...
public class BasicDeserializerFactory_findOptionalStdDeserializer_49464663793 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_findOptionalStdDeserializer_49464663793() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "findOptionalStdDeserializer", argTypes, null, args);
            assertTrue(false);
        }
