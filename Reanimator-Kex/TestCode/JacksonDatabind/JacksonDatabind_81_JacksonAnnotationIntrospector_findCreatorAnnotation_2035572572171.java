...
public class JacksonAnnotationIntrospector_findCreatorAnnotation_2035572572171 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_findCreatorAnnotation_2035572572171() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "findCreatorAnnotation", argTypes, null, args);
            assertTrue(false);
        }
