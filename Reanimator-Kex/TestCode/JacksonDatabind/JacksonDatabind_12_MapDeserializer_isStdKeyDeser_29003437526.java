...
public class MapDeserializer_isStdKeyDeser_29003437526 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public MapDeserializer_isStdKeyDeser_29003437526() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "_isStdKeyDeser", argTypes, null, args);
            assertTrue(false);
        }
