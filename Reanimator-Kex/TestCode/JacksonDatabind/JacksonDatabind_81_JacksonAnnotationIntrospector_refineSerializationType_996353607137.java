...
public class JacksonAnnotationIntrospector_refineSerializationType_996353607137 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_refineSerializationType_996353607137() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "refineSerializationType", argTypes, null, args);
            assertTrue(false);
        }
