...
public class BeanDeserializerFactory_addReferenceProperties_92605484733 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_addReferenceProperties_92605484733() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "addReferenceProperties", argTypes, null, args);
            assertTrue(false);
        }
