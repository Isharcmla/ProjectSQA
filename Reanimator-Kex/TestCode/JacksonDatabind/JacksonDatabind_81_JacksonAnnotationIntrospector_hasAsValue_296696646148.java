...
public class JacksonAnnotationIntrospector_hasAsValue_296696646148 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_hasAsValue_296696646148() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "hasAsValue", argTypes, null, args);
            assertTrue(false);
        }
