...
public class BasicDeserializerFactory_createEnumDeserializer_79196745687 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_createEnumDeserializer_79196745687() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "createEnumDeserializer", argTypes, null, args);
            assertTrue(false);
        }
