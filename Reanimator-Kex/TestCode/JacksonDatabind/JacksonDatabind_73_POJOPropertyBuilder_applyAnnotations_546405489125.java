...
public class POJOPropertyBuilder_applyAnnotations_546405489125 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public POJOPropertyBuilder_applyAnnotations_546405489125() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "_applyAnnotations", argTypes, null, args);
            assertTrue(false);
        }
