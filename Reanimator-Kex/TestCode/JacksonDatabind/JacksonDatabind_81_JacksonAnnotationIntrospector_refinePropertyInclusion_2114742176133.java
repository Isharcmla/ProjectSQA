...
public class JacksonAnnotationIntrospector_refinePropertyInclusion_2114742176133 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_refinePropertyInclusion_2114742176133() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "_refinePropertyInclusion", argTypes, null, args);
            assertTrue(false);
        }
