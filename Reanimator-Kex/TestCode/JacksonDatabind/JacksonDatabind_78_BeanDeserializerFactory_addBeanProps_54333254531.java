...
public class BeanDeserializerFactory_addBeanProps_54333254531 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_addBeanProps_54333254531() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "addBeanProps", argTypes, null, args);
            assertTrue(false);
        }
