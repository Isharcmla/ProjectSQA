...
public class BasicDeserializerFactory_createMapDeserializer_47737008881 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_createMapDeserializer_47737008881() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "createMapDeserializer", argTypes, null, args);
            assertTrue(false);
        }
