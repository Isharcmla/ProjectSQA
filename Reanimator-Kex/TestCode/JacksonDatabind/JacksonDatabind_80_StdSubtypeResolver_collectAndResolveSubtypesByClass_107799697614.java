...
public class StdSubtypeResolver_collectAndResolveSubtypesByClass_107799697614 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public StdSubtypeResolver_collectAndResolveSubtypesByClass_107799697614() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "collectAndResolveSubtypesByClass", argTypes, null, args);
            assertTrue(false);
        }
