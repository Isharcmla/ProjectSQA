...
public class JacksonAnnotationIntrospector_findViews_1054898394101 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_findViews_1054898394101() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "findViews", argTypes, null, args);
            assertTrue(false);
        }
