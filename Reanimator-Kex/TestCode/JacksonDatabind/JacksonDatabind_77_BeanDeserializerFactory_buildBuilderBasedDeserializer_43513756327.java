...
public class BeanDeserializerFactory_buildBuilderBasedDeserializer_43513756327 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_buildBuilderBasedDeserializer_43513756327() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "buildBuilderBasedDeserializer", argTypes, null, args);
            assertTrue(false);
        }
