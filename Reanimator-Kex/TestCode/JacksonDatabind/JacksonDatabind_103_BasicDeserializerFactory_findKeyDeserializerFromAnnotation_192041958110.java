...
public class BasicDeserializerFactory_findKeyDeserializerFromAnnotation_192041958110 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_findKeyDeserializerFromAnnotation_192041958110() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "findKeyDeserializerFromAnnotation", argTypes, null, args);
            assertTrue(false);
        }
