...
public class BeanDeserializerFactory_buildBeanDeserializer_126130553326 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_buildBeanDeserializer_126130553326() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "buildBeanDeserializer", argTypes, null, args);
            assertTrue(false);
        }
