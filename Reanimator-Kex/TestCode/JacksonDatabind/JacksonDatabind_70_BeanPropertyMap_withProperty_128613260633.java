...
public class BeanPropertyMap_withProperty_128613260633 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanPropertyMap_withProperty_128613260633() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "withProperty", argTypes, null, args);
            assertTrue(false);
        }
