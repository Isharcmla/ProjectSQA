...
public class StdValueInstantiator_wrapException_199956736585 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term41;

    public StdValueInstantiator_wrapException_199956736585() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term110 = Class.forName((String) "java.lang.invoke.MethodHandleImpl$LoopClauses");
        Class<? extends Object> term113 = Class.forName((String) "java.util.stream.SpinedBuffer$OfPrimitive");
        Class<? extends Object> term115 = Class.forName((String) "java.util.stream.DoubleStream");
        Class<? extends Object> term119 = Class.forName((String) "com.fasterxml.jackson.databind.jsonFormatVisitors.JsonNumberFormatVisitor");
        Class<? extends Object> term124 = Class.forName((String) "java.util.Spliterators$ArraySpliterator");
        Class<? extends Object> term128 = Class.forName((String) "java.lang.Iterable");
        Class<? extends Object> term132 = Class.forName((String) "java.util.spi.CalendarNameProvider");
        Class<? extends Object> term136 = Class.forName((String) "java.lang.InstantiationException");
        Class<? extends Object> term140 = Class.forName((String) "java.util.ArraysParallelSortHelpers$FJChar$Merger");
        Class<? extends Object> term144 = Class.forName((String) "java.io.ObjectStreamConstants");
        Class<? extends Object> term148 = Class.forName((String) "com.fasterxml.jackson.databind.jsonFormatVisitors.JsonNumberFormatVisitor");
        Class<? extends Object> term152 = Class.forName((String) "com.fasterxml.jackson.annotation.JsonAutoDetect");
        Class<? extends Object> term156 = Class.forName((String) "java.util.function.IntUnaryOperator");
        Class<? extends Object> term160 = Class.forName((String) "java.io.NotSerializableException");
        Class<? extends Object> term163 = Class.forName((String) "java.util.BitSet");
        Class<? extends Object> term166 = Class.forName((String) "java.nio.channels.GatheringByteChannel");
        Class<? extends Object> term169 = Class.forName((String) "com.fasterxml.jackson.databind.type.PlaceholderForType");
        Class<? extends Object> term172 = Class.forName((String) "java.util.stream.LongPipeline$9$1");
        Class<? extends Object> term276 = Class.forName((String) "com.fasterxml.jackson.databind.deser.std.PrimitiveArrayDeserializers$FloatDeser");
        Class<? extends Object> term278 = Class.forName((String) "java.util.regex.Pattern$Branch");
        ...
        setLongElement(term175, 4, 140671122080048L);
        setLongElement(term175, 5, 34364440080L);
        setLongElement(term175, 6, 140671122147248L);
        setLongElement(term175, 7, 140671121989648L);
        setLongElement(term175, 8, 140671121989536L);
        setLongElement(term175, 9, 140671121989680L);
        setLongElement(term175, 10, 140671122033680L);
        setLongElement(term175, 11, 34363766248L);
        setLongElement(term175, 12, 34363766248L);
        setLongElement(term175, 13, 140667513310992L);
        setLongElement(term175, 14, 140667513310992L);
        setLongElement(term175, 15, 140667513310848L);
        setLongElement(term175, 16, 140667513354752L);
        setLongElement(term175, 17, 140667513356400L);
        setLongElement(term175, 18, 140667513357168L);
        setLongElement(term175, 19, 140671123758128L);
        setLongElement(term175, 20, 34363739368L);
        setLongElement(term175, 21, 34363739368L);
        setLongElement(term175, 22, 140667513309488L);
        setLongElement(term175, 23, 34363829248L);
        setLongElement(term175, 24, 140671123758128L);
        setLongElement(term175, 25, 140671123559536L);
