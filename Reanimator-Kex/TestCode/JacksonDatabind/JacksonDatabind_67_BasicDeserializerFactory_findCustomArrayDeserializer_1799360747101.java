...
public class BasicDeserializerFactory_findCustomArrayDeserializer_1799360747101 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_findCustomArrayDeserializer_1799360747101() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[0] = Class.forName("com.fasterxml.jackson.databind.type.ArrayType");
        ...
        args[4] = null;
        try {
            callMethod(klass, "_findCustomArrayDeserializer", argTypes, null, args);
            assertTrue(false);
        }
