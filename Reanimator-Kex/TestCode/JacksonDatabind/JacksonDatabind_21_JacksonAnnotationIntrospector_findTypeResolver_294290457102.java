...
public class JacksonAnnotationIntrospector_findTypeResolver_294290457102 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_findTypeResolver_294290457102() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "findTypeResolver", argTypes, null, args);
            assertTrue(false);
        }
