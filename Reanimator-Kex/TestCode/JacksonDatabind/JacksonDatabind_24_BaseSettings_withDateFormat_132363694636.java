...
public class BaseSettings_withDateFormat_132363694636 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BaseSettings_withDateFormat_132363694636() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "withDateFormat", argTypes, null, args);
            assertTrue(false);
        }
