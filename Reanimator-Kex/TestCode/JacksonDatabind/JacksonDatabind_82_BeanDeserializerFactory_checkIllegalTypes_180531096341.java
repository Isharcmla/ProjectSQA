...
public class BeanDeserializerFactory_checkIllegalTypes_180531096341 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_checkIllegalTypes_180531096341() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "checkIllegalTypes", argTypes, null, args);
            assertTrue(false);
        }
