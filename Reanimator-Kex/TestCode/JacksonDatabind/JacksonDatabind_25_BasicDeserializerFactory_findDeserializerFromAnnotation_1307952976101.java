...
public class BasicDeserializerFactory_findDeserializerFromAnnotation_1307952976101 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_findDeserializerFromAnnotation_1307952976101() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "findDeserializerFromAnnotation", argTypes, null, args);
            assertTrue(false);
        }
