...
public class DatabindContext_objectIdResolverInstance_12661548416 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DatabindContext_objectIdResolverInstance_12661548416() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "objectIdResolverInstance", argTypes, null, args);
            assertTrue(false);
        }
