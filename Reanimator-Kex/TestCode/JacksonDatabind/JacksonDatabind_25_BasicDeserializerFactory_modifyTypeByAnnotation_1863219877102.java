...
public class BasicDeserializerFactory_modifyTypeByAnnotation_1863219877102 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_modifyTypeByAnnotation_1863219877102() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "modifyTypeByAnnotation", argTypes, null, args);
            assertTrue(false);
        }
