...
public class TypeFactory_resolveSuperInterfaces_2012576038123 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public TypeFactory_resolveSuperInterfaces_2012576038123() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "_resolveSuperInterfaces", argTypes, null, args);
            assertTrue(false);
        }
