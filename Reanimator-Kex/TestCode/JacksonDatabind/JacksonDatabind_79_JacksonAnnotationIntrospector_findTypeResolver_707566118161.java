...
public class JacksonAnnotationIntrospector_findTypeResolver_707566118161 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_findTypeResolver_707566118161() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "_findTypeResolver", argTypes, null, args);
            assertTrue(false);
        }
