...
public class BaseSettings_withTypeFactory_77982773134 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BaseSettings_withTypeFactory_77982773134() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "withTypeFactory", argTypes, null, args);
            assertTrue(false);
        }
