...
public class BasicSerializerFactory_findSerializerFromAnnotation_142662145547 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicSerializerFactory_findSerializerFromAnnotation_142662145547() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "findSerializerFromAnnotation", argTypes, null, args);
            assertTrue(false);
        }
