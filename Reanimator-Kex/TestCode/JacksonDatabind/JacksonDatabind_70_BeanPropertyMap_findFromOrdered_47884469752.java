...
public class BeanPropertyMap_findFromOrdered_47884469752 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanPropertyMap_findFromOrdered_47884469752() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "_findFromOrdered", argTypes, null, args);
            assertTrue(false);
        }
