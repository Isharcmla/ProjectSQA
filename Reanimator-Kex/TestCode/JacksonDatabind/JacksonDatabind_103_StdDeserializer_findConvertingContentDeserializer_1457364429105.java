...
public class StdDeserializer_findConvertingContentDeserializer_1457364429105 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public StdDeserializer_findConvertingContentDeserializer_1457364429105() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "findConvertingContentDeserializer", argTypes, null, args);
            assertTrue(false);
        }
