...
public class StdDeserializer_findContentNullProvider_1522029609109 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public StdDeserializer_findContentNullProvider_1522029609109() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "findContentNullProvider", argTypes, null, args);
            assertTrue(false);
        }
