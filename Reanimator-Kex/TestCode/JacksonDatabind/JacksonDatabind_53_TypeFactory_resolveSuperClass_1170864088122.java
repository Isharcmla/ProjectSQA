...
public class TypeFactory_resolveSuperClass_1170864088122 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public TypeFactory_resolveSuperClass_1170864088122() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "_resolveSuperClass", argTypes, null, args);
            assertTrue(false);
        }
