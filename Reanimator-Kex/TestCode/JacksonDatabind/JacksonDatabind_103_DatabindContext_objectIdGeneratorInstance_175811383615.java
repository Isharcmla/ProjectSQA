...
public class DatabindContext_objectIdGeneratorInstance_175811383615 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DatabindContext_objectIdGeneratorInstance_175811383615() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "objectIdGeneratorInstance", argTypes, null, args);
            assertTrue(false);
        }
