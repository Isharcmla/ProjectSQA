...
public class BeanDeserializerFactory_buildThrowableDeserializer_186201012730 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_buildThrowableDeserializer_186201012730() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "buildThrowableDeserializer", argTypes, null, args);
            assertTrue(false);
        }
