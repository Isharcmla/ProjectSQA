...
public class BeanDeserializerFactory_addInjectables_106651474332 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_addInjectables_106651474332() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "addInjectables", argTypes, null, args);
            assertTrue(false);
        }
