...
public class BeanDeserializerFactory_withConfig_190051976822 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_withConfig_190051976822() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "withConfig", argTypes, null, args);
            assertTrue(false);
        }
