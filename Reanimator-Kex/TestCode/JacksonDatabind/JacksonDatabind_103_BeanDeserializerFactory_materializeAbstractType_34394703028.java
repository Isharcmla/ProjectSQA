...
public class BeanDeserializerFactory_materializeAbstractType_34394703028 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_materializeAbstractType_34394703028() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "materializeAbstractType", argTypes, null, args);
            assertTrue(false);
        }
