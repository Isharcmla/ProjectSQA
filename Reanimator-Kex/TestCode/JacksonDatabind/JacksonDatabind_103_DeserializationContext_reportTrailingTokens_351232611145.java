...
public class DeserializationContext_reportTrailingTokens_351232611145 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DeserializationContext_reportTrailingTokens_351232611145() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "reportTrailingTokens", argTypes, null, args);
            assertTrue(false);
        }
