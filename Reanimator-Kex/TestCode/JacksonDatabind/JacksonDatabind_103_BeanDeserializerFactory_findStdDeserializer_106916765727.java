...
public class BeanDeserializerFactory_findStdDeserializer_106916765727 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_findStdDeserializer_106916765727() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "findStdDeserializer", argTypes, null, args);
            assertTrue(false);
        }
