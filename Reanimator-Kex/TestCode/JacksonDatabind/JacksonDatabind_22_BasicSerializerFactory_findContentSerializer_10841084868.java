...
public class BasicSerializerFactory_findContentSerializer_10841084868 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicSerializerFactory_findContentSerializer_10841084868() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "_findContentSerializer", argTypes, null, args);
            assertTrue(false);
        }
