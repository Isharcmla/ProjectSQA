...
public class StdDeserializer_coerceNullToken_91101313093 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term265;

    public StdDeserializer_coerceNullToken_91101313093() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = term265;
        try {
            callMethod(klass, "_coerceNullToken", argTypes, null, args);
            assertTrue(false);
        }
