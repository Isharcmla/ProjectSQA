...
public class JacksonAnnotationIntrospector_findObjectReferenceInfo_2072815622118 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_findObjectReferenceInfo_2072815622118() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[1] = null;
        try {
            callMethod(klass, "findObjectReferenceInfo", argTypes, null, args);
            assertTrue(false);
        }
