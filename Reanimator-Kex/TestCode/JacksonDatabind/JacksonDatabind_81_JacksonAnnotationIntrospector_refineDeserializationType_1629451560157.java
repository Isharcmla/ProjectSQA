...
public class JacksonAnnotationIntrospector_refineDeserializationType_1629451560157 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public JacksonAnnotationIntrospector_refineDeserializationType_1629451560157() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "refineDeserializationType", argTypes, null, args);
            assertTrue(false);
        }
