...
public class CreatorCollector_setDefaultCreator_35909430426 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public CreatorCollector_setDefaultCreator_35909430426() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "setDefaultCreator", argTypes, null, args);
            assertTrue(false);
        }
