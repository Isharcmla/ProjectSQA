...
public class BeanDeserializerFactory_addObjectIdReader_68732060831 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BeanDeserializerFactory_addObjectIdReader_68732060831() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "addObjectIdReader", argTypes, null, args);
            assertTrue(false);
        }
