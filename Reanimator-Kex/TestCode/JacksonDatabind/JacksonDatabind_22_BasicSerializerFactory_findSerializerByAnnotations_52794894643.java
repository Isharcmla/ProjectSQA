...
public class BasicSerializerFactory_findSerializerByAnnotations_52794894643 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicSerializerFactory_findSerializerByAnnotations_52794894643() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "findSerializerByAnnotations", argTypes, null, args);
            assertTrue(false);
        }
