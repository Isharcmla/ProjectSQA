...
public class BasicDeserializerFactory_findDefaultDeserializer_110550322198 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BasicDeserializerFactory_findDefaultDeserializer_110550322198() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "findDefaultDeserializer", argTypes, null, args);
            assertTrue(false);
        }
