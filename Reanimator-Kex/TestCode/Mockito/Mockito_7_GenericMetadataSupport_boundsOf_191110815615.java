...
public class GenericMetadataSupport_boundsOf_191110815615 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GenericMetadataSupport_boundsOf_191110815615() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "boundsOf", argTypes, null, args);
            assertTrue(false);
        }
