...
public class GenericMetadataSupport_getActualTypeArgumentFor_77185452921 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public GenericMetadataSupport_getActualTypeArgumentFor_77185452921() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "getActualTypeArgumentFor", argTypes, null, args);
            assertTrue(false);
        }
