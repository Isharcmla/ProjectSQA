...
public class ZipArchiveEntry_init_155222083344 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term28609 = Class.forName((String) "java.util.concurrent.TimeUnit");
        Field term28608 = ((Class) term28609).getDeclaredField((String) "MILLISECONDS");
        ((Field) term28608).setAccessible(true);
        Object enum104 = ((Field) term28608).get((Object) null);
        Class<? extends Object> term28807 = Class.forName((String) "java.util.concurrent.TimeUnit");
        Field term28806 = ((Class) term28807).getDeclaredField((String) "MINUTES");
        ((Field) term28806).setAccessible(true);
        Object enum105 = ((Field) term28806).get((Object) null);
        Class<? extends Object> term28990 = Class.forName((String) "java.util.concurrent.TimeUnit");
        Field term28989 = ((Class) term28990).getDeclaredField((String) "DAYS");
        ((Field) term28989).setAccessible(true);
        Object enum106 = ((Field) term28989).get((Object) null);
