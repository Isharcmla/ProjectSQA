...
public class ZipArchiveEntry_init_17140711145 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term893;

    public ZipArchiveEntry_init_17140711145() {
    }
    ...
    public void setup() throws Throwable {
        ...
        Class<? extends Object> term30526 = Class.forName((String) "java.util.concurrent.TimeUnit");
        Field term30525 = ((Class) term30526).getDeclaredField((String) "HOURS");
        ((Field) term30525).setAccessible(true);
        Object enum110 = ((Field) term30525).get((Object) null);
        Class<? extends Object> term30713 = Class.forName((String) "java.util.concurrent.TimeUnit");
        Field term30712 = ((Class) term30713).getDeclaredField((String) "SECONDS");
        ((Field) term30712).setAccessible(true);
        Object enum111 = ((Field) term30712).get((Object) null);
        ...
        setField(term935, term935.getClass(), "unit", enum110);
        ...
        setField(term969, term969.getClass(), "unit", enum110);
        ...
        setField(term986, term986.getClass(), "unit", enum111);
