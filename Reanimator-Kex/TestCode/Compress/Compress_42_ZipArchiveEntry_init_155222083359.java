...
public class ZipArchiveEntry_init_155222083359 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term23;

    public ZipArchiveEntry_init_155222083359() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term38568 = Class.forName((String) "java.util.concurrent.TimeUnit");
        Field term38567 = ((Class) term38568).getDeclaredField((String) "MILLISECONDS");
        ((Field) term38567).setAccessible(true);
        Object enum142 = ((Field) term38567).get((Object) null);
        Class<? extends Object> term38766 = Class.forName((String) "java.util.concurrent.TimeUnit");
        Field term38765 = ((Class) term38766).getDeclaredField((String) "MINUTES");
        ((Field) term38765).setAccessible(true);
        Object enum143 = ((Field) term38765).get((Object) null);
        Class<? extends Object> term38949 = Class.forName((String) "java.util.concurrent.TimeUnit");
        Field term38948 = ((Class) term38949).getDeclaredField((String) "DAYS");
        ((Field) term38948).setAccessible(true);
        Object enum144 = ((Field) term38948).get((Object) null);
        ...
        setField(term37, term37.getClass(), "unit", enum142);
        ...
        setField(term78, term78.getClass(), "unit", enum143);
        ...
        setField(term114, term114.getClass(), "unit", enum144);
