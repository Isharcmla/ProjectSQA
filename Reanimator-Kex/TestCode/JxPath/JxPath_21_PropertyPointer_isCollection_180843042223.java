...
public class PropertyPointer_isCollection_180843042223 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public PropertyPointer_isCollection_180843042223() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        try {
            callMethod(klass, "isCollection", argTypes, null, args);
            assertTrue(false);
        }
