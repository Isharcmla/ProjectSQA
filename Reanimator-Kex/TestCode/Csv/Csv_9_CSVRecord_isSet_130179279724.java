...
public class CSVRecord_isSet_130179279724 {
    ...
    public void setup() throws Throwable {
        ...
        term4417 = newInstance(Class.forName("org.apache.commons.csv.CSVRecord"));
        Object[] term4421 = (Object[]) newArray("java.lang.String", 9);
        setField(term4417, term4417.getClass(), "comment", "nGKItKLYNC");
        setField(term4417, term4417.getClass(), "mapping", term4420);
        setLongField(term4417, term4417.getClass(), "recordNumber", -7237588299778557629L);
        setElement(term4421, 0, "UoYtihxVaS");
        setElement(term4421, 1, "JDswTTCZHV");
        setElement(term4421, 2, "onpbIeEKoi");
        setElement(term4421, 3, "YRHGsAkhxb");
        setElement(term4421, 4, "ffYhPOzlUs");
        setElement(term4421, 5, "MLqYREekMl");
        setElement(term4421, 6, "ytSBIKXogI");
        setElement(term4421, 7, "nHXjMycHlU");
        setElement(term4421, 8, "ieCtQFdkii");
        setField(term4417, term4417.getClass(), "values", term4421);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term1051, term4417));
