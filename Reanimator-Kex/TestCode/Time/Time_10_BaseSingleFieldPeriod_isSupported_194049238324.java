...
public class BaseSingleFieldPeriod_isSupported_194049238324 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public BaseSingleFieldPeriod_isSupported_194049238324() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "isSupported", argTypes, null, args);
            assertTrue(false);
        }
