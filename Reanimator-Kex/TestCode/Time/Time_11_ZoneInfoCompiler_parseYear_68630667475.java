...
public class ZoneInfoCompiler_parseYear_68630667475 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ZoneInfoCompiler_parseYear_68630667475() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = "max";
        args[1] = 0;
        Object retValue = callMethod(klass, "parseYear", argTypes, null, args);
