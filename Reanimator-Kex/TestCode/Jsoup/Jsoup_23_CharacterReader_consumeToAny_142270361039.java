...
public class CharacterReader_consumeToAny_142270361039 {
    ...
    public void setup() throws Throwable {
        ...
        term2475 = newInstance(Class.forName("org.jsoup.parser.CharacterReader"));
        setField(term2475, term2475.getClass(), "input", "LQFpaHEwXR");
        setIntField(term2475, term2475.getClass(), "length", -226514366);
        setIntField(term2475, term2475.getClass(), "pos", 1193880199);
        setIntField(term2475, term2475.getClass(), "mark", -1087774327);
        term2478 = (char[]) newCharArray(5);
        setCharElement(term2478, 0, 'A');
        setCharElement(term2478, 1, 'E');
        setCharElement(term2478, 2, 'B');
        setCharElement(term2478, 3, 't');
        setCharElement(term2478, 4, 'n');
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term333, term2475));
        assertTrue(recursiveEquals(term349, term2478));
