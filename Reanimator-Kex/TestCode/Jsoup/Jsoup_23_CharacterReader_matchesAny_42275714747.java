...
public class CharacterReader_matchesAny_42275714747 {
    ...
    public void setup() throws Throwable {
        ...
        term4319 = newInstance(Class.forName("org.jsoup.parser.CharacterReader"));
        setField(term4319, term4319.getClass(), "input", "eZFUvlxvGV");
        setIntField(term4319, term4319.getClass(), "length", -184153539);
        setIntField(term4319, term4319.getClass(), "pos", 493620644);
        setIntField(term4319, term4319.getClass(), "mark", 1328271830);
        term4322 = (char[]) newCharArray(4);
        setCharElement(term4322, 0, 't');
        setCharElement(term4322, 1, 'T');
        setCharElement(term4322, 2, 'D');
        setCharElement(term4322, 3, 's');
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term598, term4319));
        assertTrue(recursiveEquals(term614, term4322));
