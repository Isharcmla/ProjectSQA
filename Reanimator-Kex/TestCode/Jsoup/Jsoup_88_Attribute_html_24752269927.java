...
public class Attribute_html_24752269927 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term78268 = Class.forName((String) "org.jsoup.nodes.Entities$EscapeMode");
        Field term78267 = ((Class) term78268).getDeclaredField((String) "base");
        ((Field) term78267).setAccessible(true);
        Object enum12 = ((Field) term78267).get((Object) null);
        Class<? extends Object> term78488 = Class.forName((String) "org.jsoup.nodes.Entities$CoreCharset");
        Field term78487 = ((Class) term78488).getDeclaredField((String) "utf");
        ((Field) term78487).setAccessible(true);
        Object enum13 = ((Field) term78487).get((Object) null);
        Class<? extends Object> term78684 = Class.forName((String) "org.jsoup.nodes.Document$OutputSettings$Syntax");
        Field term78683 = ((Class) term78684).getDeclaredField((String) "html");
        ((Field) term78683).setAccessible(true);
        Object enum14 = ((Field) term78683).get((Object) null);
