...
public class Element_nodelistChanged_1523958946132 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1589;
     Object term13497;

    public Element_nodelistChanged_1523958946132() {
    }
    ...
    public void setup() throws Throwable {
        ...
        setBooleanField(term1590, term1590.getClass(), "isBlock", true);
        ...
        term13497 = newInstance(Class.forName("org.jsoup.nodes.Element"));
        Object term13498 = newInstance(Class.forName("org.jsoup.parser.Tag"));
        Object term13503 = newInstance(Class.forName("org.jsoup.nodes.Attributes"));
        Object[] term13504 = (Object[]) newArray("java.lang.String", 0);
        Object[] term13505 = (Object[]) newArray("java.lang.String", 0);
        setField(term13498, term13498.getClass(), "tagName", "UoYtihxVaS");
        setBooleanField(term13498, term13498.getClass(), "isBlock", true);
        setBooleanField(term13498, term13498.getClass(), "formatAsBlock", true);
        setBooleanField(term13498, term13498.getClass(), "canContainInline", true);
        setBooleanField(term13498, term13498.getClass(), "empty", false);
        setBooleanField(term13498, term13498.getClass(), "selfClosing", true);
        setBooleanField(term13498, term13498.getClass(), "preserveWhitespace", false);
        setBooleanField(term13498, term13498.getClass(), "formList", true);
        setBooleanField(term13498, term13498.getClass(), "formSubmit", true);
        setField(term13497, term13497.getClass(), "tag", term13498);
        setField(term13497, term13497.getClass(), "shadowChildrenRef", null);
        setField(term13497, term13497.getClass(), "childNodes", term13501);
        setIntField(term13503, term13503.getClass(), "size", 1876565163);
        setField(term13503, term13503.getClass(), "keys", term13504);
        setField(term13503, term13503.getClass(), "vals", term13505);
        setField(term13497, term13497.getClass(), "attributes", term13503);
        setField(term13497, term13497.getClass(), "baseUri", "JDswTTCZHV");
        setField(term13497, term13497.getClass(), "parentNode", null);
        setIntField(term13497, term13497.getClass(), "siblingIndex", -817164822);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term1589, term13497));
    }
