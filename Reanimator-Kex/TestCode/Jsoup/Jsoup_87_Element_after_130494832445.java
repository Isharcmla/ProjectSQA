...
public class Element_after_130494832445 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3245;

    public Element_after_130494832445() {
    }
    ...
    public void setup() throws Throwable {
        ...
        setBooleanField(term3246, term3246.getClass(), "isBlock", true);
        setBooleanField(term3246, term3246.getClass(), "formatAsBlock", false);
        setBooleanField(term3246, term3246.getClass(), "canContainInline", true);
        setBooleanField(term3246, term3246.getClass(), "empty", false);
        setBooleanField(term3246, term3246.getClass(), "selfClosing", false);
        setBooleanField(term3246, term3246.getClass(), "preserveWhitespace", true);
        setBooleanField(term3246, term3246.getClass(), "formList", false);
