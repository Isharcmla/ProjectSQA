...
public class Element_firstElementSibling_1098119627163 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term3736;

    public Element_firstElementSibling_1098119627163() {
    }
    ...
    public void setup() throws Throwable {
        ...
        setBooleanField(term3737, term3737.getClass(), "isBlock", false);
        ...
        setBooleanField(term3737, term3737.getClass(), "empty", true);
        setBooleanField(term3737, term3737.getClass(), "selfClosing", false);
        setBooleanField(term3737, term3737.getClass(), "preserveWhitespace", true);
        setBooleanField(term3737, term3737.getClass(), "formList", true);
        setBooleanField(term3737, term3737.getClass(), "formSubmit", false);
    ...
    public void test() throws Throwable, Throwable {
        ...
        try {
            callMethod(klass, "firstElementSibling", argTypes, term3736, args);
            assertTrue(false);
        }
