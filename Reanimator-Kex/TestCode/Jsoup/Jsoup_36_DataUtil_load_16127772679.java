...
public class DataUtil_load_16127772679 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1;

    public DataUtil_load_16127772679() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term899 = Class.forName((String) "java.io.File$PathStatus");
        Field term898 = ((Class) term899).getDeclaredField((String) "INVALID");
        ((Field) term898).setAccessible(true);
        Object enum1 = ((Field) term898).get((Object) null);
