...
public class Entities_escape_14432844056 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term1410 = Class.forName((String) "org.jsoup.nodes.Entities$EscapeMode");
        Field term1409 = ((Class) term1410).getDeclaredField((String) "base");
        ((Field) term1409).setAccessible(true);
        enum4 = ((Field) term1409).get((Object) null);
    }
