...
public class Attributes_html_185990860655 {
    ...
    public void setup() throws Throwable {
        ...
        Class<? extends Object> term62474 = Class.forName((String) "org.jsoup.nodes.Entities$EscapeMode");
        Field term62473 = ((Class) term62474).getDeclaredField((String) "base");
        ((Field) term62473).setAccessible(true);
        Object enum3 = ((Field) term62473).get((Object) null);
        Class<? extends Object> term62694 = Class.forName((String) "org.jsoup.nodes.Entities$CoreCharset");
        Field term62693 = ((Class) term62694).getDeclaredField((String) "utf");
        ((Field) term62693).setAccessible(true);
        Object enum4 = ((Field) term62693).get((Object) null);
        Class<? extends Object> term62890 = Class.forName((String) "org.jsoup.nodes.Document$OutputSettings$Syntax");
        Field term62889 = ((Class) term62890).getDeclaredField((String) "html");
        ((Field) term62889).setAccessible(true);
        Object enum5 = ((Field) term62889).get((Object) null);
