...
public class Cleaner_clean_17149344726 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term1657 =  ((Map) term28).keySet();
        HashSet term27 = new HashSet((Collection<? extends Object>) term1657);
        ...
        Class<? extends Object> term1659 = Class.forName((String) "org.jsoup.nodes.Document$QuirksMode");
        Field term1658 = ((Class) term1659).getDeclaredField((String) "quirks");
        ((Field) term1658).setAccessible(true);
        Object enum2 = ((Field) term1658).get((Object) null);
        HashMap term84 = new HashMap();
        Set<Object> term1868 =  ((Map) term84).keySet();
        HashSet term83 = new HashSet((Collection<? extends Object>) term1868);
