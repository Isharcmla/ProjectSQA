...
public class CharacterReader_consumeTo_169485570956 {
    ...
    public void setup() throws Throwable {
        ...
        term9015 = newInstance(Class.forName("org.jsoup.parser.CharacterReader"));
        char[] term9016 = (char[]) newCharArray(5);
        Object[] term9017 = (Object[]) newArray("java.lang.String", 3);
        setCharElement(term9016, 0, 'S');
        setCharElement(term9016, 1, 'b');
        setCharElement(term9016, 2, 'S');
        setCharElement(term9016, 3, 'z');
        setCharElement(term9016, 4, 'j');
        setField(term9015, term9015.getClass(), "charBuf", term9016);
        setField(term9015, term9015.getClass(), "reader", null);
        setIntField(term9015, term9015.getClass(), "bufLength", -1588772968);
        setIntField(term9015, term9015.getClass(), "bufSplitPoint", -93135961);
        setIntField(term9015, term9015.getClass(), "bufPos", -1588772968);
        setIntField(term9015, term9015.getClass(), "readerPos", 933028652);
        setIntField(term9015, term9015.getClass(), "bufMark", 287287233);
        setElement(term9017, 0, "xLbjWUgOIL");
        setElement(term9017, 1, "jDtqGUpnZN");
        setElement(term9017, 2, "nGKItKLYNC");
        setField(term9015, term9015.getClass(), "stringCache", term9017);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term1279, term9015));
