...
public class Attribute_html_24752269927 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term78206 = Class.forName((String) "org.jsoup.nodes.Entities$EscapeMode");
        Field term78205 = ((Class) term78206).getDeclaredField((String) "base");
        ((Field) term78205).setAccessible(true);
        Object enum12 = ((Field) term78205).get((Object) null);
        Class<? extends Object> term78426 = Class.forName((String) "org.jsoup.nodes.Entities$CoreCharset");
        Field term78425 = ((Class) term78426).getDeclaredField((String) "utf");
        ((Field) term78425).setAccessible(true);
        Object enum13 = ((Field) term78425).get((Object) null);
        Class<? extends Object> term78622 = Class.forName((String) "org.jsoup.nodes.Document$OutputSettings$Syntax");
        Field term78621 = ((Class) term78622).getDeclaredField((String) "html");
        ((Field) term78621).setAccessible(true);
        Object enum14 = ((Field) term78621).get((Object) null);
        ...
        setIntField(term2113, term2113.getClass(), "threadLocalHashCode", -2105893575);
