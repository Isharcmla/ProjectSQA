...
public class EqualityUtils {
    ...
    public static boolean equalsObjectArray(Object[] t1, Object[] t2, Map<Object, Object> visitedFirstToSecond, Map<Object, Object> visitedSecondToFirst) {
        if (t1.length != t2.length) {
            return false;
        }

        for (int i=0; i<t1.length; i++) {
            if (!equalsAll(t1[i], t2[i], visitedFirstToSecond, visitedSecondToFirst)) {
                return false;
            }
    ...
    public static boolean equalsObject(Object t1, Object t2, Map<Object, Object> visitedFirstToSecond, Map<Object, Object> visitedSecondToFirst) {
        if (containsKey(visitedFirstToSecond, t1) || containsKey(visitedSecondToFirst, t2)) {
    ...
    public static boolean recursiveEquals(Object t1, Object t2) {
