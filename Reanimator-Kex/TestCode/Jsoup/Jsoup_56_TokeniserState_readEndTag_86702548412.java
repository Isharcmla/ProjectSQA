...
public class TokeniserState_readEndTag_86702548412 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term40974 = Class.forName((String) "org.jsoup.parser.TokeniserState");
        Field term40973 = ((Class) term40974).getDeclaredField((String) "BogusComment");
        ((Field) term40973).setAccessible(true);
        Object enum134 = ((Field) term40973).get((Object) null);
        Class<? extends Object> term41270 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term41269 = ((Class) term41270).getDeclaredField((String) "StartTag");
        ((Field) term41269).setAccessible(true);
        Object enum135 = ((Field) term41269).get((Object) null);
        LinkedHashMap term8645 = new LinkedHashMap();
        Class<? extends Object> term41517 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term41516 = ((Class) term41517).getDeclaredField((String) "EndTag");
        ((Field) term41516).setAccessible(true);
        Object enum136 = ((Field) term41516).get((Object) null);
        Class<? extends Object> term41712 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term41711 = ((Class) term41712).getDeclaredField((String) "Character");
        ((Field) term41711).setAccessible(true);
        Object enum137 = ((Field) term41711).get((Object) null);
        Class<? extends Object> term41954 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term41953 = ((Class) term41954).getDeclaredField((String) "Doctype");
        ((Field) term41953).setAccessible(true);
        Object enum138 = ((Field) term41953).get((Object) null);
        Class<? extends Object> term42158 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term42157 = ((Class) term42158).getDeclaredField((String) "Comment");
        ((Field) term42157).setAccessible(true);
        Object enum139 = ((Field) term42157).get((Object) null);
        ...
        Class<? extends Object> term42433 = Class.forName((String) "org.jsoup.parser.TokeniserState");
        Field term42432 = ((Class) term42433).getDeclaredField((String) "AttributeValue_doubleQuoted");
        ((Field) term42432).setAccessible(true);
        enum140 = ((Field) term42432).get((Object) null);
        Class<? extends Object> term42676 = Class.forName((String) "org.jsoup.parser.TokeniserState");
        Field term42675 = ((Class) term42676).getDeclaredField((String) "AfterDoctypePublicIdentifier");
        ((Field) term42675).setAccessible(true);
        enum141 = ((Field) term42675).get((Object) null);
    }
