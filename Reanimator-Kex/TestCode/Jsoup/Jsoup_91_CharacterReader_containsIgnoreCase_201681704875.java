...
public class CharacterReader_containsIgnoreCase_201681704875 {
    ...
    public void setup() throws Throwable {
        ...
        term14995 = newInstance(Class.forName("org.jsoup.parser.CharacterReader"));
        char[] term14996 = (char[]) newCharArray(5);
        Object[] term14997 = (Object[]) newArray("java.lang.String", 1);
        setCharElement(term14996, 0, 'b');
        setCharElement(term14996, 1, 'c');
        setCharElement(term14996, 2, 'd');
        setCharElement(term14996, 3, 'z');
        setCharElement(term14996, 4, 'j');
        setField(term14995, term14995.getClass(), "charBuf", term14996);
        setField(term14995, term14995.getClass(), "reader", null);
        setIntField(term14995, term14995.getClass(), "bufLength", -523949691);
        setIntField(term14995, term14995.getClass(), "bufSplitPoint", 1398204340);
        setIntField(term14995, term14995.getClass(), "bufPos", 229204365);
        setIntField(term14995, term14995.getClass(), "readerPos", -461771056);
        setIntField(term14995, term14995.getClass(), "bufMark", -243422082);
        setElement(term14997, 0, "HzqpegHiRq");
        setField(term14995, term14995.getClass(), "stringCache", term14997);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term3883, term14995));
