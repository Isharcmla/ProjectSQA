...
public class DataUtil_readFileToByteBuffer_212676327020 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term391;

    public DataUtil_readFileToByteBuffer_212676327020() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term3604 = Class.forName((String) "java.io.File$PathStatus");
        Field term3603 = ((Class) term3604).getDeclaredField((String) "INVALID");
        ((Field) term3603).setAccessible(true);
        Object enum3 = ((Field) term3603).get((Object) null);
