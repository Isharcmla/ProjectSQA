...
public class TokeniserState_readCharRef_105707458911 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term38702 = Class.forName((String) "org.jsoup.parser.TokeniserState");
        Field term38701 = ((Class) term38702).getDeclaredField((String) "AfterDoctypePublicKeyword");
        ((Field) term38701).setAccessible(true);
        Object enum127 = ((Field) term38701).get((Object) null);
        Class<? extends Object> term39037 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term39036 = ((Class) term39037).getDeclaredField((String) "StartTag");
        ((Field) term39036).setAccessible(true);
        Object enum128 = ((Field) term39036).get((Object) null);
        LinkedHashMap term6467 = new LinkedHashMap();
        Class<? extends Object> term39284 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term39283 = ((Class) term39284).getDeclaredField((String) "EndTag");
        ((Field) term39283).setAccessible(true);
        Object enum129 = ((Field) term39283).get((Object) null);
        Class<? extends Object> term39479 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term39478 = ((Class) term39479).getDeclaredField((String) "Character");
        ((Field) term39478).setAccessible(true);
        Object enum130 = ((Field) term39478).get((Object) null);
        Class<? extends Object> term39721 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term39720 = ((Class) term39721).getDeclaredField((String) "Doctype");
        ((Field) term39720).setAccessible(true);
        Object enum131 = ((Field) term39720).get((Object) null);
        Class<? extends Object> term39925 = Class.forName((String) "org.jsoup.parser.Token$TokenType");
        Field term39924 = ((Class) term39925).getDeclaredField((String) "Comment");
        ((Field) term39924).setAccessible(true);
        Object enum132 = ((Field) term39924).get((Object) null);
        ...
        Class<? extends Object> term40133 = Class.forName((String) "org.jsoup.parser.TokeniserState");
        Field term40132 = ((Class) term40133).getDeclaredField((String) "ScriptDataDoubleEscapedDashDash");
        ((Field) term40132).setAccessible(true);
        enum133 = ((Field) term40132).get((Object) null);
    }
