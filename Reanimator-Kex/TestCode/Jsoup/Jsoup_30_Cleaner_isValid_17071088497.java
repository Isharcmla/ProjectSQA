...
public class Cleaner_isValid_17071088497 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term2616 =  ((Map) term391).keySet();
        HashSet term390 = new HashSet((Collection<? extends Object>) term2616);
        ...
        Class<? extends Object> term2618 = Class.forName((String) "org.jsoup.nodes.Document$QuirksMode");
        Field term2617 = ((Class) term2618).getDeclaredField((String) "limitedQuirks");
        ((Field) term2617).setAccessible(true);
        Object enum4 = ((Field) term2617).get((Object) null);
        HashMap term454 = new HashMap();
        Set<Object> term2848 =  ((Map) term454).keySet();
        HashSet term453 = new HashSet((Collection<? extends Object>) term2848);
