...
public class Entities_escape_14432844056 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term1414 = Class.forName((String) "org.jsoup.nodes.Entities$EscapeMode");
        Field term1413 = ((Class) term1414).getDeclaredField((String) "base");
        ((Field) term1413).setAccessible(true);
        enum4 = ((Field) term1413).get((Object) null);
    }
