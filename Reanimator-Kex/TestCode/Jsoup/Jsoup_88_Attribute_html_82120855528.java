...
public class Attribute_html_82120855528 {
    ...
    public void setup() throws Throwable {
        ...
        Class<? extends Object> term79201 = Class.forName((String) "org.jsoup.nodes.Entities$EscapeMode");
        Field term79200 = ((Class) term79201).getDeclaredField((String) "base");
        ((Field) term79200).setAccessible(true);
        Object enum15 = ((Field) term79200).get((Object) null);
        Class<? extends Object> term79421 = Class.forName((String) "org.jsoup.nodes.Entities$CoreCharset");
        Field term79420 = ((Class) term79421).getDeclaredField((String) "fallback");
        ((Field) term79420).setAccessible(true);
        Object enum16 = ((Field) term79420).get((Object) null);
        Class<? extends Object> term79632 = Class.forName((String) "org.jsoup.nodes.Document$OutputSettings$Syntax");
        Field term79631 = ((Class) term79632).getDeclaredField((String) "html");
        ((Field) term79631).setAccessible(true);
        Object enum17 = ((Field) term79631).get((Object) null);
        ...
        setIntField(term47102, term47102.getClass(), "threadLocalHashCode", -613288677);
