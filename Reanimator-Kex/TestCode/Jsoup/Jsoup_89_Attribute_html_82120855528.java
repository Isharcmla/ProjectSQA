...
public class Attribute_html_82120855528 {
    ...
    public void setup() throws Throwable {
        ...
        Class<? extends Object> term79230 = Class.forName((String) "org.jsoup.nodes.Entities$EscapeMode");
        Field term79229 = ((Class) term79230).getDeclaredField((String) "base");
        ((Field) term79229).setAccessible(true);
        Object enum15 = ((Field) term79229).get((Object) null);
        Class<? extends Object> term79450 = Class.forName((String) "org.jsoup.nodes.Entities$CoreCharset");
        Field term79449 = ((Class) term79450).getDeclaredField((String) "fallback");
        ((Field) term79449).setAccessible(true);
        Object enum16 = ((Field) term79449).get((Object) null);
        Class<? extends Object> term79661 = Class.forName((String) "org.jsoup.nodes.Document$OutputSettings$Syntax");
        Field term79660 = ((Class) term79661).getDeclaredField((String) "html");
        ((Field) term79660).setAccessible(true);
        Object enum17 = ((Field) term79660).get((Object) null);
