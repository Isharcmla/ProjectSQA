...
public class JsonWriter_setLenient_13377478034 {
    ...
    public void setup() throws Throwable {
        ...
        term3298 = newInstance(Class.forName("com.google.gson.stream.JsonWriter"));
        int[] term3299 = (int[]) newIntArray(4);
        setField(term3298, term3298.getClass(), "out", null);
        setIntElement(term3299, 0, -1955890973);
        setIntElement(term3299, 1, -2038273078);
        setIntElement(term3299, 2, 1227103734);
        setIntElement(term3299, 3, -1339778481);
        setField(term3298, term3298.getClass(), "stack", term3299);
        setIntField(term3298, term3298.getClass(), "stackSize", 1725571209);
        setField(term3298, term3298.getClass(), "indent", "jJCZpVmanW");
        setField(term3298, term3298.getClass(), "separator", "EGtDIRbSSb");
        setBooleanField(term3298, term3298.getClass(), "lenient", true);
        setBooleanField(term3298, term3298.getClass(), "htmlSafe", true);
        setField(term3298, term3298.getClass(), "deferredName", "SzjVpOQTyS");
        setBooleanField(term3298, term3298.getClass(), "serializeNulls", true);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term105, term3298));
