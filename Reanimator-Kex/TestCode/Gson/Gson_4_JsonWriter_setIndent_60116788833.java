...
public class JsonWriter_setIndent_60116788833 {
    ...
    public void setup() throws Throwable {
        ...
        term3159 = newInstance(Class.forName("com.google.gson.stream.JsonWriter"));
        int[] term3160 = (int[]) newIntArray(5);
        setField(term3159, term3159.getClass(), "out", null);
        setIntElement(term3160, 0, 568599855);
        setIntElement(term3160, 1, 1162663216);
        setIntElement(term3160, 2, 1484323161);
        setIntElement(term3160, 3, 391863371);
        setIntElement(term3160, 4, -1922583790);
        setField(term3159, term3159.getClass(), "stack", term3160);
        setIntField(term3159, term3159.getClass(), "stackSize", -616727354);
        setField(term3159, term3159.getClass(), "indent", "xxtlPwDYFs");
        setField(term3159, term3159.getClass(), "separator", ": ");
        setBooleanField(term3159, term3159.getClass(), "lenient", false);
        setBooleanField(term3159, term3159.getClass(), "htmlSafe", false);
        setField(term3159, term3159.getClass(), "deferredName", "MuLcgQHgqz");
        setBooleanField(term3159, term3159.getClass(), "serializeNulls", false);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term1, term3159));
    }
