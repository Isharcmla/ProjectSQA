...
public class JsonWriter_isHtmlSafe_112648353337 {
    ...
    public void setup() throws Throwable {
        ...
        term3659 = newInstance(Class.forName("com.google.gson.stream.JsonWriter"));
        int[] term3660 = (int[]) newIntArray(1);
        setField(term3659, term3659.getClass(), "out", null);
        setIntElement(term3660, 0, -655067527);
        setField(term3659, term3659.getClass(), "stack", term3660);
        setIntField(term3659, term3659.getClass(), "stackSize", -6029667);
        setField(term3659, term3659.getClass(), "indent", "LQFpaHEwXR");
        setField(term3659, term3659.getClass(), "separator", "oVcInYnLWB");
        setBooleanField(term3659, term3659.getClass(), "lenient", false);
        setBooleanField(term3659, term3659.getClass(), "htmlSafe", false);
        setField(term3659, term3659.getClass(), "deferredName", "aJlieCFVtF");
        setBooleanField(term3659, term3659.getClass(), "serializeNulls", true);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term347, term3659));
    }
