...
public class JsonWriter_isLenient_23081965035 {
    ...
    public void setup() throws Throwable {
        ...
        term3418 = newInstance(Class.forName("com.google.gson.stream.JsonWriter"));
        int[] term3419 = (int[]) newIntArray(3);
        setField(term3418, term3418.getClass(), "out", null);
        setIntElement(term3419, 0, -522618178);
        setIntElement(term3419, 1, 1134449235);
        setIntElement(term3419, 2, -883034806);
        setField(term3418, term3418.getClass(), "stack", term3419);
        setIntField(term3418, term3418.getClass(), "stackSize", 1585847225);
        setField(term3418, term3418.getClass(), "indent", "MjGYSRKTNF");
        setField(term3418, term3418.getClass(), "separator", "hRNSzYYIrc");
        setBooleanField(term3418, term3418.getClass(), "lenient", true);
        setBooleanField(term3418, term3418.getClass(), "htmlSafe", false);
        setField(term3418, term3418.getClass(), "deferredName", "RMFIsYGgne");
        setBooleanField(term3418, term3418.getClass(), "serializeNulls", true);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term187, term3418));
    }
