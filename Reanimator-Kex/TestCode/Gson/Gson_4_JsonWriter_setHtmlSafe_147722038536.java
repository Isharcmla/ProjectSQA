...
public class JsonWriter_setHtmlSafe_147722038536 {
    ...
    public void setup() throws Throwable {
        ...
        term3541 = newInstance(Class.forName("com.google.gson.stream.JsonWriter"));
        int[] term3542 = (int[]) newIntArray(4);
        setField(term3541, term3541.getClass(), "out", null);
        setIntElement(term3542, 0, 597278769);
        setIntElement(term3542, 1, -1685132342);
        setIntElement(term3542, 2, -1456670397);
        setIntElement(term3542, 3, 1622346318);
        setField(term3541, term3541.getClass(), "stack", term3542);
        setIntField(term3541, term3541.getClass(), "stackSize", 1048535127);
        setField(term3541, term3541.getClass(), "indent", "NRdvgJlhkX");
        setField(term3541, term3541.getClass(), "separator", "uuaPigETmJ");
        setBooleanField(term3541, term3541.getClass(), "lenient", false);
        setBooleanField(term3541, term3541.getClass(), "htmlSafe", true);
        setField(term3541, term3541.getClass(), "deferredName", "MxlszYVzRf");
        setBooleanField(term3541, term3541.getClass(), "serializeNulls", false);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term265, term3541));
