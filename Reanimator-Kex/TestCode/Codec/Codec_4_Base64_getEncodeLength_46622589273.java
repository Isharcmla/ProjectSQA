...
public class Base64_getEncodeLength_46622589273 {
    ...
    public void setup() throws Throwable {
        ...
        term2430 = new Integer(-481533957);
        ...
        term11903 = (byte[]) newByteArray(5);
        setByteElement(term11903, 0, (byte) -41);
        setByteElement(term11903, 1, (byte) -88);
        setByteElement(term11903, 2, (byte) 39);
        setByteElement(term11903, 3, (byte) -1);
        setByteElement(term11903, 4, (byte) 117);
        term11904 = (byte[]) newByteArray(5);
        setByteElement(term11904, 0, (byte) 43);
        setByteElement(term11904, 1, (byte) -27);
        setByteElement(term11904, 2, (byte) 34);
        setByteElement(term11904, 3, (byte) -126);
        setByteElement(term11904, 4, (byte) 12);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term2424, term11903));
        assertTrue(recursiveEquals(term2430, -481533957));
        assertTrue(recursiveEquals(term2432, term11904));
