...
public class Base64_getEncodeLength_46622589273 {
    ...
    public void setup() throws Throwable {
        ...
        term12088 = (byte[]) newByteArray(5);
        setByteElement(term12088, 0, (byte) -41);
        setByteElement(term12088, 1, (byte) -88);
        setByteElement(term12088, 2, (byte) 39);
        setByteElement(term12088, 3, (byte) -1);
        setByteElement(term12088, 4, (byte) 117);
        term12089 = (byte[]) newByteArray(5);
        setByteElement(term12089, 0, (byte) 43);
        setByteElement(term12089, 1, (byte) -27);
        setByteElement(term12089, 2, (byte) 34);
        setByteElement(term12089, 3, (byte) -126);
        setByteElement(term12089, 4, (byte) 12);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term2424, term12088));
        assertTrue(recursiveEquals(term2430, -1034506028));
        assertTrue(recursiveEquals(term2432, term12089));
