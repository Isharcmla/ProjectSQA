...
public class StringUtils_newStringUtf8_158259298441 {
    ...
    public void setup() throws Throwable {
        term2964 = (byte[]) newByteArray(2);
        setByteElement(term2964, 0, (byte) -2);
        setByteElement(term2964, 1, (byte) -16);
        term6839 = (byte[]) newByteArray(2);
        setByteElement(term6839, 0, (byte) -2);
        setByteElement(term6839, 1, (byte) -16);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term2964, term6839));
