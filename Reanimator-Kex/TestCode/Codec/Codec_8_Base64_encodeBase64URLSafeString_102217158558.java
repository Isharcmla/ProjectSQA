...
public class Base64_encodeBase64URLSafeString_102217158558 {
    ...
    public void setup() throws Throwable {
        ...
        term7382 = (byte[]) newByteArray(6);
        setByteElement(term7382, 0, (byte) 45);
        setByteElement(term7382, 1, (byte) -39);
        setByteElement(term7382, 2, (byte) -20);
        setByteElement(term7382, 3, (byte) 10);
        setByteElement(term7382, 4, (byte) 77);
        setByteElement(term7382, 5, (byte) 14);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term1342, term7382));
