...
public class StringUtils_newString_16585646834 {
    ...
    public void setup() throws Throwable {
        term2895 = (byte[]) newByteArray(6);
        setByteElement(term2895, 0, (byte) 47);
        setByteElement(term2895, 1, (byte) 48);
        setByteElement(term2895, 2, (byte) 89);
        setByteElement(term2895, 3, (byte) 75);
        setByteElement(term2895, 4, (byte) 18);
        setByteElement(term2895, 5, (byte) -58);
    }
