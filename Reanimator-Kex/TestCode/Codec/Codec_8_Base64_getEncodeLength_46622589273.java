...
public class Base64_getEncodeLength_46622589273 {
    ...
    public void setup() throws Throwable {
        ...
        term11842 = (byte[]) newByteArray(5);
        setByteElement(term11842, 0, (byte) -41);
        setByteElement(term11842, 1, (byte) -88);
        setByteElement(term11842, 2, (byte) 39);
        setByteElement(term11842, 3, (byte) -1);
        setByteElement(term11842, 4, (byte) 117);
        term11843 = (byte[]) newByteArray(5);
        setByteElement(term11843, 0, (byte) 43);
        setByteElement(term11843, 1, (byte) -27);
        setByteElement(term11843, 2, (byte) 34);
        setByteElement(term11843, 3, (byte) -126);
        setByteElement(term11843, 4, (byte) 12);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term2424, term11842));
        assertTrue(recursiveEquals(term2430, -1034506028));
        assertTrue(recursiveEquals(term2432, term11843));
