...
public class StringUtils_newString_163520315235 {
    ...
    public void setup() throws Throwable {
        term2908 = (byte[]) newByteArray(5);
        setByteElement(term2908, 0, (byte) -29);
        setByteElement(term2908, 1, (byte) -54);
        setByteElement(term2908, 2, (byte) -10);
        setByteElement(term2908, 3, (byte) 79);
        setByteElement(term2908, 4, (byte) -119);
    }
