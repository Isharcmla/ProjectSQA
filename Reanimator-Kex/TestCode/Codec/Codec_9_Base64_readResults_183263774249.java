...
public class Base64_readResults_183263774249 {
    ...
    public Base64_readResults_183263774249() {
    }
    ...
    public void setup() throws Throwable {
        ...
        setIntField(term639, term639.getClass(), "lineLength", 865208305);
        setByteElement(term706, 0, (byte) 13);
        setByteElement(term706, 1, (byte) 10);
        setField(term639, term639.getClass(), "lineSeparator", term706);
        setIntField(term639, term639.getClass(), "decodeSize", 3);
        setIntField(term639, term639.getClass(), "encodeSize", 4);
        setByteElement(term711, 0, (byte) -16);
        setByteElement(term711, 1, (byte) -112);
        setField(term639, term639.getClass(), "buffer", term711);
        setIntField(term639, term639.getClass(), "pos", -1275173084);
        setIntField(term639, term639.getClass(), "readPos", -244121226);
        setIntField(term639, term639.getClass(), "currentLinePos", -203030934);
        setIntField(term639, term639.getClass(), "modulus", -1179120542);
        setBooleanField(term639, term639.getClass(), "eof", true);
        setIntField(term639, term639.getClass(), "x", -73683645);
        ...
        term727 = new Integer(-226514366);
        term729 = new Integer(1193880199);
    }
