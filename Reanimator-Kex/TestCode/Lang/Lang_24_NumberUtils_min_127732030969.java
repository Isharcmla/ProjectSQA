...
public class NumberUtils_min_127732030969 {
    ...
    public void setup() throws Throwable {
        ...
        term6748 = (int[]) newIntArray(4);
        setIntElement(term6748, 0, 1162663216);
        setIntElement(term6748, 1, 1484323161);
        setIntElement(term6748, 2, 391863371);
        setIntElement(term6748, 3, -1922583790);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term464, term6748));
    }
