...
public class NumberUtils_max_75853920378 {
    ...
    public void setup() throws Throwable {
        ...
        term6983 = (double[]) newDoubleArray(6);
        setDoubleElement(term6983, 0, 0.5523635872663106);
        setDoubleElement(term6983, 1, 0.544608645520025);
        setDoubleElement(term6983, 2, 0.28570734989730284);
        setDoubleElement(term6983, 3, 0.40176586625454525);
        setDoubleElement(term6983, 4, 0.2641345529914265);
        setDoubleElement(term6983, 5, 0.36923381893433327);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term541, term6983));
