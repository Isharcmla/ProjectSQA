...
public class NumberUtils_min_127732030969 {
    ...
    public void setup() throws Throwable {
        ...
        term6750 = (int[]) newIntArray(4);
        setIntElement(term6750, 0, 1162663216);
        setIntElement(term6750, 1, 1484323161);
        setIntElement(term6750, 2, 391863371);
        setIntElement(term6750, 3, -1922583790);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term464, term6750));
    }
