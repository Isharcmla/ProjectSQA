...
public class StrBuilder_replaceImpl_404695259242 {
    ...
    public void setup() throws Throwable {
        ...
        term75044 = newInstance(Class.forName("org.apache.commons.lang.text.StrBuilder"));
        char[] term75045 = (char[]) newCharArray(32);
        setField(term75044, term75044.getClass(), "buffer", term75045);
        setIntField(term75044, term75044.getClass(), "size", -341152642);
        setField(term75044, term75044.getClass(), "newLine", "XYtryyobou");
        setField(term75044, term75044.getClass(), "nullText", "OYbzXylRWW");
        term74908 = newInstance(Class.forName("org.apache.commons.lang.text.StrBuilder"));
        char[] term74909 = (char[]) newCharArray(32);
        setField(term74908, term74908.getClass(), "buffer", term74909);
        setIntField(term74908, term74908.getClass(), "size", -341152642);
        setField(term74908, term74908.getClass(), "newLine", "XYtryyobou");
        setField(term74908, term74908.getClass(), "nullText", "OYbzXylRWW");
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term8741, term75044));
        ...
        assertTrue(recursiveEquals(retValue, term74908));
    }
