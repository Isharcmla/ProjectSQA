...
public class DateUtils_isSameInstant_206525768860 {
    ...
    public DateUtils_isSameInstant_206525768860() {
    }
    ...
    public void setup() throws Throwable {
        ...
        term15401 = newInstance(Class.forName("java.util.Date"));
        setLongField(term15401, term15401.getClass(), "fastTime", 1610958182830L);
        setField(term15401, term15401.getClass(), "cdate", null);
        term15402 = newInstance(Class.forName("java.util.Date"));
        setLongField(term15402, term15402.getClass(), "fastTime", 1606063635837L);
        setField(term15402, term15402.getClass(), "cdate", null);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term1189, term15401));
        assertTrue(recursiveEquals(term1191, term15402));
