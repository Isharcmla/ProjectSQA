...
public class CMAESOptimizer_inverse_177201660129 {
    ...
    public void setup() throws Throwable {
        term70683 = (int[]) newIntArray(0);
        term70701 = (int[]) newIntArray(0);
        term70699 = (int[]) newIntArray(0);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term70683, term70701));
        assertTrue(recursiveEquals(retValue, term70699));
    }
