...
public class FastMath_asinh_1172107307416 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public FastMath_asinh_1172107307416() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = 0.005070991717859034;
        Object retValue = callMethod(klass, "asinh", argTypes, null, args);
        assertTrue(recursiveEquals(retValue, 0.0050709699847215255));
    }
