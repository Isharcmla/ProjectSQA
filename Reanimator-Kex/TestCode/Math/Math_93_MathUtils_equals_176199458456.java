...
public class MathUtils_equals_176199458456 {
    ...
    public void setup() throws Throwable {
        ...
        term1675 = (double[]) newDoubleArray(5);
        setDoubleElement(term1675, 0, 0.544608645520025);
        setDoubleElement(term1675, 1, 0.28570734989730284);
        setDoubleElement(term1675, 2, 0.40176586625454525);
        setDoubleElement(term1675, 3, 0.2641345529914265);
        setDoubleElement(term1675, 4, 0.36923381893433327);
        term1676 = (double[]) newDoubleArray(4);
        setDoubleElement(term1676, 0, 0.6076495596892013);
        setDoubleElement(term1676, 1, 0.37773193782763337);
        setDoubleElement(term1676, 2, 0.8474802076607362);
        setDoubleElement(term1676, 3, 0.5183269973490326);
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        assertTrue(recursiveEquals(term53, term1675));
        assertTrue(recursiveEquals(term59, term1676));
