...
public class AbstractLeastSquaresOptimizer_squareRoot_118351129839 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractLeastSquaresOptimizer_squareRoot_118351129839() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "squareRoot", argTypes, null, args);
            assertTrue(false);
        }
