...
public class FastMath_asinh_1172107307257 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public FastMath_asinh_1172107307257() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = -0.1299270689317339;
        Object retValue = callMethod(klass, "asinh", argTypes, null, args);
        assertTrue(recursiveEquals(retValue, -0.12956426749571678));
    }
