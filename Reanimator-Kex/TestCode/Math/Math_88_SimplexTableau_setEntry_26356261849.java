...
public class SimplexTableau_setEntry_26356261849 {
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term43501 = Class.forName((String) "org.apache.commons.math.optimization.linear.Relationship");
        Field term43500 = ((Class) term43501).getDeclaredField((String) "LEQ");
        ((Field) term43500).setAccessible(true);
        Object enum108 = ((Field) term43500).get((Object) null);
        ...
        setField(term9608, term9608.getClass(), "relationship", enum108);
        setDoubleField(term9608, term9608.getClass(), "value", 0.7865909711092062);
        Class<? extends Object> term43797 = Class.forName((String) "org.apache.commons.math.optimization.linear.Relationship");
        Field term43796 = ((Class) term43797).getDeclaredField((String) "GEQ");
        ((Field) term43796).setAccessible(true);
        Object enum109 = ((Field) term43796).get((Object) null);
        ...
        setField(term9612, term9612.getClass(), "relationship", enum109);
        ...
        setField(term9616, term9616.getClass(), "relationship", enum108);
        ...
        setField(term9618, term9618.getClass(), "relationship", enum109);
        ...
        setField(term9620, term9620.getClass(), "relationship", enum108);
