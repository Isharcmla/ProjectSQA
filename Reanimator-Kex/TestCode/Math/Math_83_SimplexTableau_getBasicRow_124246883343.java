...
public class SimplexTableau_getBasicRow_124246883343 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term4624;
     Object term4646;

    public SimplexTableau_getBasicRow_124246883343() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term38360 = Class.forName((String) "org.apache.commons.math.optimization.linear.Relationship");
        Field term38359 = ((Class) term38360).getDeclaredField((String) "GEQ");
        ((Field) term38359).setAccessible(true);
        Object enum94 = ((Field) term38359).get((Object) null);
        ...
        setField(term4629, term4629.getClass(), "relationship", enum94);
        setDoubleField(term4629, term4629.getClass(), "value", 0.6588948704887806);
        Class<? extends Object> term38656 = Class.forName((String) "org.apache.commons.math.optimization.linear.Relationship");
        Field term38655 = ((Class) term38656).getDeclaredField((String) "EQ");
        ((Field) term38655).setAccessible(true);
        Object enum95 = ((Field) term38655).get((Object) null);
        ...
        setField(term4633, term4633.getClass(), "relationship", enum95);
        ...
        setField(term4637, term4637.getClass(), "relationship", enum95);
