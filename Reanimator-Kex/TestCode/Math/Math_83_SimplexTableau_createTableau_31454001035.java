...
public class SimplexTableau_createTableau_31454001035 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term5;
     Object term33;

    public SimplexTableau_createTableau_31454001035() {
    }
    ...
    public void setup() throws Throwable {
        Class<? extends Object> term28236 = Class.forName((String) "org.apache.commons.math.optimization.linear.Relationship");
        Field term28235 = ((Class) term28236).getDeclaredField((String) "LEQ");
        ((Field) term28235).setAccessible(true);
        Object enum64 = ((Field) term28235).get((Object) null);
        ...
        setField(term10, term10.getClass(), "relationship", enum64);
        setDoubleField(term10, term10.getClass(), "value", 0.5523635872663106);
        Class<? extends Object> term28532 = Class.forName((String) "org.apache.commons.math.optimization.linear.Relationship");
        Field term28531 = ((Class) term28532).getDeclaredField((String) "GEQ");
        ((Field) term28531).setAccessible(true);
        Object enum65 = ((Field) term28531).get((Object) null);
        ...
        setField(term14, term14.getClass(), "relationship", enum65);
        ...
        setField(term18, term18.getClass(), "relationship", enum64);
        ...
        setField(term20, term20.getClass(), "relationship", enum65);
        setDoubleField(term20, term20.getClass(), "value", 0.40176586625454525);
        Class<? extends Object> term28828 = Class.forName((String) "org.apache.commons.math.optimization.linear.Relationship");
        Field term28827 = ((Class) term28828).getDeclaredField((String) "GEQ");
        ((Field) term28827).setAccessible(true);
        Object enum66 = ((Field) term28827).get((Object) null);
        ...
        setField(term22, term22.getClass(), "relationship", enum66);
