...
public class AbstractCategoryItemRenderer_drawOutline_1920393140107 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractCategoryItemRenderer_drawOutline_1920393140107() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "drawOutline", argTypes, null, args);
            assertTrue(false);
        }
