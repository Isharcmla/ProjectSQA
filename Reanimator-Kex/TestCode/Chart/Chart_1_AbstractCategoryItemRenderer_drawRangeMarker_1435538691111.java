...
public class AbstractCategoryItemRenderer_drawRangeMarker_1435538691111 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public AbstractCategoryItemRenderer_drawRangeMarker_1435538691111() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        argTypes[3] = Class.forName("org.jfree.chart.plot.Marker");
        ...
        args[4] = null;
        try {
            callMethod(klass, "drawRangeMarker", argTypes, null, args);
            assertTrue(false);
        }
