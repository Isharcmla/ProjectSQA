...
public class ToXmlGenerator_setNextIsAttribute_66625044978 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term11;

    public ToXmlGenerator_setNextIsAttribute_66625044978() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = term11;
        try {
            callMethod(klass, "setNextIsAttribute", argTypes, null, args);
            assertTrue(false);
        }
