...
public class XmlTokenStream_skipEndElement_39291586627 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public XmlTokenStream_skipEndElement_39291586627() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        try {
            callMethod(klass, "skipEndElement", argTypes, null, args);
            assertTrue(false);
        }
