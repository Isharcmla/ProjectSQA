...
public class XmlTokenStream_skipAttributes_73973181238 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public XmlTokenStream_skipAttributes_73973181238() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        try {
            callMethod(klass, "skipAttributes", argTypes, null, args);
            assertTrue(false);
        }
