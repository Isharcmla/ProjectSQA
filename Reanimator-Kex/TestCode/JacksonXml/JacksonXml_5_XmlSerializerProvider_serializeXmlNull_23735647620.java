...
public class XmlSerializerProvider_serializeXmlNull_23735647620 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public XmlSerializerProvider_serializeXmlNull_23735647620() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "_serializeXmlNull", argTypes, null, args);
            assertTrue(false);
        }
