...
public class XmlSerializerProvider_asXmlGenerator_68640120921 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public XmlSerializerProvider_asXmlGenerator_68640120921() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "_asXmlGenerator", argTypes, null, args);
            assertTrue(false);
        }
