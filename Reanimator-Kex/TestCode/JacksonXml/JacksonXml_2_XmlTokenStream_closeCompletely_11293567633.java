...
public class XmlTokenStream_closeCompletely_11293567633 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public XmlTokenStream_closeCompletely_11293567633() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        try {
            callMethod(klass, "closeCompletely", argTypes, null, args);
            assertTrue(false);
        }
