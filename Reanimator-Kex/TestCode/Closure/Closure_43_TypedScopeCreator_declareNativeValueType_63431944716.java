...
public class TypedScopeCreator_declareNativeValueType_63431944716 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term7327 =  ((Map) term1964).keySet();
        HashSet term1963 = new HashSet((Collection<? extends Object>) term7327);
        HashMap term1970 = new HashMap();
        Set<Object> term7328 =  ((Map) term1970).keySet();
        HashSet term1969 = new HashSet((Collection<? extends Object>) term7328);
        HashMap term1976 = new HashMap();
        Set<Object> term7329 =  ((Map) term1976).keySet();
        HashSet term1975 = new HashSet((Collection<? extends Object>) term7329);
        ...
        Class<? extends Object> term7341 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term7340 = ((Class) term7341).getDeclaredField((String) "TYPE_ERROR_FUNCTION_TYPE");
        ((Field) term7340).setAccessible(true);
        enum4 = ((Field) term7340).get((Object) null);
    }
