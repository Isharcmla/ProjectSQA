...
public class CodeGenerator_addLeftExpr_164961673842 {
    ...
    public void setup() throws Throwable {
        ...
        Class<? extends Object> term6072 = Class.forName((String) "com.google.javascript.jscomp.CodeGenerator$Context");
        Field term6071 = ((Class) term6072).getDeclaredField((String) "IN_FOR_INIT_CLAUSE");
        ((Field) term6071).setAccessible(true);
        enum10 = ((Field) term6071).get((Object) null);
    }
