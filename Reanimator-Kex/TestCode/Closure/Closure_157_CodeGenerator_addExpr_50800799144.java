...
public class CodeGenerator_addExpr_50800799144 {
    ...
    public void setup() throws Throwable {
        ...
        Class<? extends Object> term7161 = Class.forName((String) "com.google.javascript.jscomp.CodeGenerator$Context");
        Field term7160 = ((Class) term7161).getDeclaredField((String) "OTHER");
        ((Field) term7160).setAccessible(true);
        enum11 = ((Field) term7160).get((Object) null);
    }
