...
public class TypedScopeCreator_declareNativeValueType_63431944715 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term10458 =  ((Map) term2989).keySet();
        HashSet term2988 = new HashSet((Collection<? extends Object>) term10458);
        HashMap term2995 = new HashMap();
        Set<Object> term10459 =  ((Map) term2995).keySet();
        HashSet term2994 = new HashSet((Collection<? extends Object>) term10459);
        HashMap term3001 = new HashMap();
        Set<Object> term10460 =  ((Map) term3001).keySet();
        HashSet term3000 = new HashSet((Collection<? extends Object>) term10460);
        HashMap term3006 = new HashMap();
        HashMap term3011 = new HashMap();
        Class<? extends Object> term10472 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeRegistry$ResolveMode");
        Field term10471 = ((Class) term10472).getDeclaredField((String) "IMMEDIATE");
        ((Field) term10471).setAccessible(true);
        Object enum15 = ((Field) term10471).get((Object) null);
        ...
        Class<? extends Object> term10821 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term10820 = ((Class) term10821).getDeclaredField((String) "ERROR_FUNCTION_TYPE");
        ((Field) term10820).setAccessible(true);
        enum16 = ((Field) term10820).get((Object) null);
    }
