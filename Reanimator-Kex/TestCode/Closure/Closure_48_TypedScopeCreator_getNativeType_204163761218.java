...
public class TypedScopeCreator_getNativeType_204163761218 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term8127 =  ((Map) term2552).keySet();
        HashSet term2551 = new HashSet((Collection<? extends Object>) term8127);
        HashMap term2558 = new HashMap();
        Set<Object> term8128 =  ((Map) term2558).keySet();
        HashSet term2557 = new HashSet((Collection<? extends Object>) term8128);
        HashMap term2564 = new HashMap();
        Set<Object> term8129 =  ((Map) term2564).keySet();
        HashSet term2563 = new HashSet((Collection<? extends Object>) term8129);
        ...
        Class<? extends Object> term8131 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term8130 = ((Class) term8131).getDeclaredField((String) "GREATEST_FUNCTION_TYPE");
        ((Field) term8130).setAccessible(true);
        enum5 = ((Field) term8130).get((Object) null);
    }
