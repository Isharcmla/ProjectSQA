...
public class TypeCheck_init_155695655966 {
    ...
    public TypeCheck_init_155695655966() {
    }
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term13671 =  ((Map) term13).keySet();
        HashSet term12 = new HashSet((Collection<? extends Object>) term13671);
        HashMap term26 = new HashMap();
        Set<Object> term13672 =  ((Map) term26).keySet();
        HashSet term25 = new HashSet((Collection<? extends Object>) term13672);
        HashMap term39 = new HashMap();
        Set<Object> term13673 =  ((Map) term39).keySet();
        HashSet term38 = new HashSet((Collection<? extends Object>) term13673);
        ...
        setField(term99, term99.getClass(), "thisType", null);
        ...
        setField(term84, term84.getClass(), "thisType", null);
        setBooleanField(term84, term84.getClass(), "isBottom", false);
        setField(term84, term84.getClass(), "arguments", null);
        Class<? extends Object> term13675 = Class.forName((String) "com.google.javascript.jscomp.CheckLevel");
        Field term13674 = ((Class) term13675).getDeclaredField((String) "WARNING");
        ((Field) term13674).setAccessible(true);
        enum17 = ((Field) term13674).get((Object) null);
        Class<? extends Object> term13898 = Class.forName((String) "com.google.javascript.jscomp.CheckLevel");
        Field term13897 = ((Class) term13898).getDeclaredField((String) "OFF");
        ((Field) term13897).setAccessible(true);
        enum18 = ((Field) term13897).get((Object) null);
    }
