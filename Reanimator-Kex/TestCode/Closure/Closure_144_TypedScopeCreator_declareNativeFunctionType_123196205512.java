...
public class TypedScopeCreator_declareNativeFunctionType_123196205512 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term1002;
     Object term1076;
     Object enum11;

    public TypedScopeCreator_declareNativeFunctionType_123196205512() {
    }
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term8076 =  ((Map) term1013).keySet();
        HashSet term1012 = new HashSet((Collection<? extends Object>) term8076);
        HashMap term1019 = new HashMap();
        Set<Object> term8077 =  ((Map) term1019).keySet();
        HashSet term1018 = new HashSet((Collection<? extends Object>) term8077);
        HashMap term1025 = new HashMap();
        Set<Object> term8078 =  ((Map) term1025).keySet();
        HashSet term1024 = new HashSet((Collection<? extends Object>) term8078);
        HashMap term1030 = new HashMap();
        HashMap term1035 = new HashMap();
        Class<? extends Object> term8090 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeRegistry$ResolveMode");
        Field term8089 = ((Class) term8090).getDeclaredField((String) "LAZY_NAMES");
        ((Field) term8089).setAccessible(true);
        Object enum10 = ((Field) term8089).get((Object) null);
        ...
        setField(term1004, term1004.getClass(), "resolveMode", enum10);
        ...
        Class<? extends Object> term8432 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term8431 = ((Class) term8432).getDeclaredField((String) "REFERENCE_ERROR_TYPE");
        ((Field) term8431).setAccessible(true);
        enum11 = ((Field) term8431).get((Object) null);
    }
