...
public class TypeInference_getNativeType_159300705587 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term27339 =  ((Map) term6194).keySet();
        HashSet term6193 = new HashSet((Collection<? extends Object>) term27339);
        HashMap term6201 = new HashMap();
        Set<Object> term27340 =  ((Map) term6201).keySet();
        HashSet term6200 = new HashSet((Collection<? extends Object>) term27340);
        HashMap term6208 = new HashMap();
        Set<Object> term27341 =  ((Map) term6208).keySet();
        HashSet term6207 = new HashSet((Collection<? extends Object>) term27341);
        ...
        Class<? extends Object> term27343 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term27342 = ((Class) term27343).getDeclaredField((String) "REGEXP_FUNCTION_TYPE");
        ((Field) term27342).setAccessible(true);
        enum32 = ((Field) term27342).get((Object) null);
    }
