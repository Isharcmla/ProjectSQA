...
public class TypedScopeCreator_declareNativeFunctionType_123196205515 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term6759 =  ((Map) term346).keySet();
        HashSet term345 = new HashSet((Collection<? extends Object>) term6759);
        HashMap term352 = new HashMap();
        Set<Object> term6760 =  ((Map) term352).keySet();
        HashSet term351 = new HashSet((Collection<? extends Object>) term6760);
        HashMap term358 = new HashMap();
        Set<Object> term6761 =  ((Map) term358).keySet();
        HashSet term357 = new HashSet((Collection<? extends Object>) term6761);
        ...
        setField(term337, term337.getClass(), "templateTypes", null);
        ...
        Class<? extends Object> term6763 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term6762 = ((Class) term6763).getDeclaredField((String) "RANGE_ERROR_TYPE");
        ((Field) term6762).setAccessible(true);
        enum3 = ((Field) term6762).get((Object) null);
    }
