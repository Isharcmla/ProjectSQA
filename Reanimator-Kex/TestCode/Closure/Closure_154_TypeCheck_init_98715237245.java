...
public class TypeCheck_init_98715237245 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);
     Object term586;
     Object enum14;
     Object enum15;

    public TypeCheck_init_98715237245() {
    }
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term11765 =  ((Map) term598).keySet();
        HashSet term597 = new HashSet((Collection<? extends Object>) term11765);
        HashMap term604 = new HashMap();
        Set<Object> term11766 =  ((Map) term604).keySet();
        HashSet term603 = new HashSet((Collection<? extends Object>) term11766);
        HashMap term615 = new HashMap();
        Set<Object> term11767 =  ((Map) term615).keySet();
        HashSet term614 = new HashSet((Collection<? extends Object>) term11767);
        ...
        Class<? extends Object> term11769 = Class.forName((String) "com.google.javascript.jscomp.CheckLevel");
        Field term11768 = ((Class) term11769).getDeclaredField((String) "WARNING");
        ((Field) term11768).setAccessible(true);
        enum14 = ((Field) term11768).get((Object) null);
        Class<? extends Object> term11992 = Class.forName((String) "com.google.javascript.jscomp.CheckLevel");
        Field term11991 = ((Class) term11992).getDeclaredField((String) "OFF");
        ((Field) term11991).setAccessible(true);
        enum15 = ((Field) term11991).get((Object) null);
    }
