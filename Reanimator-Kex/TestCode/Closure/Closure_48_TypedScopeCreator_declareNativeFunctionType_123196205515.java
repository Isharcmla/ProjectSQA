...
public class TypedScopeCreator_declareNativeFunctionType_123196205515 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term6777 =  ((Map) term346).keySet();
        HashSet term345 = new HashSet((Collection<? extends Object>) term6777);
        HashMap term352 = new HashMap();
        Set<Object> term6778 =  ((Map) term352).keySet();
        HashSet term351 = new HashSet((Collection<? extends Object>) term6778);
        HashMap term358 = new HashMap();
        Set<Object> term6779 =  ((Map) term358).keySet();
        HashSet term357 = new HashSet((Collection<? extends Object>) term6779);
        ...
        Class<? extends Object> term6781 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term6780 = ((Class) term6781).getDeclaredField((String) "SYNTAX_ERROR_TYPE");
        ((Field) term6780).setAccessible(true);
        enum3 = ((Field) term6780).get((Object) null);
    }
