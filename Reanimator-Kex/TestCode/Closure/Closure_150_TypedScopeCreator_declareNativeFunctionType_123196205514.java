...
public class TypedScopeCreator_declareNativeFunctionType_123196205514 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term9534 =  ((Map) term1013).keySet();
        HashSet term1012 = new HashSet((Collection<? extends Object>) term9534);
        HashMap term1019 = new HashMap();
        Set<Object> term9535 =  ((Map) term1019).keySet();
        HashSet term1018 = new HashSet((Collection<? extends Object>) term9535);
        HashMap term1025 = new HashMap();
        Set<Object> term9536 =  ((Map) term1025).keySet();
        HashSet term1024 = new HashSet((Collection<? extends Object>) term9536);
        HashMap term1030 = new HashMap();
        HashMap term1035 = new HashMap();
        Class<? extends Object> term9548 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeRegistry$ResolveMode");
        Field term9547 = ((Class) term9548).getDeclaredField((String) "LAZY_EXPRESSIONS");
        ((Field) term9547).setAccessible(true);
        Object enum13 = ((Field) term9547).get((Object) null);
        ...
        Class<? extends Object> term9908 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term9907 = ((Class) term9908).getDeclaredField((String) "REFERENCE_ERROR_TYPE");
        ((Field) term9907).setAccessible(true);
        enum14 = ((Field) term9907).get((Object) null);
    }
