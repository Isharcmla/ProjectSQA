...
public class TypeCheck_init_122880885442 {
    ...
    public TypeCheck_init_122880885442() {
    }
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term11321 =  ((Map) term13).keySet();
        HashSet term12 = new HashSet((Collection<? extends Object>) term11321);
        HashMap term26 = new HashMap();
        Set<Object> term11322 =  ((Map) term26).keySet();
        HashSet term25 = new HashSet((Collection<? extends Object>) term11322);
        HashMap term39 = new HashMap();
        Set<Object> term11323 =  ((Map) term39).keySet();
        HashSet term38 = new HashSet((Collection<? extends Object>) term11323);
        ...
        setField(term82, term82.getClass(), "arguments", null);
        Class<? extends Object> term11325 = Class.forName((String) "com.google.javascript.jscomp.CheckLevel");
        Field term11324 = ((Class) term11325).getDeclaredField((String) "WARNING");
        ((Field) term11324).setAccessible(true);
        enum12 = ((Field) term11324).get((Object) null);
        Class<? extends Object> term11548 = Class.forName((String) "com.google.javascript.jscomp.CheckLevel");
        Field term11547 = ((Class) term11548).getDeclaredField((String) "OFF");
        ((Field) term11547).setAccessible(true);
        enum13 = ((Field) term11547).get((Object) null);
    }
