...
public class TypedScopeCreator_createInitialScope_76224746413 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term8931 =  ((Map) term534).keySet();
        HashSet term533 = new HashSet((Collection<? extends Object>) term8931);
        HashMap term540 = new HashMap();
        Set<Object> term8932 =  ((Map) term540).keySet();
        HashSet term539 = new HashSet((Collection<? extends Object>) term8932);
        HashMap term546 = new HashMap();
        Set<Object> term8933 =  ((Map) term546).keySet();
        HashSet term545 = new HashSet((Collection<? extends Object>) term8933);
        HashMap term551 = new HashMap();
        HashMap term556 = new HashMap();
        Class<? extends Object> term8945 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeRegistry$ResolveMode");
        Field term8944 = ((Class) term8945).getDeclaredField((String) "IMMEDIATE");
        ((Field) term8944).setAccessible(true);
        Object enum12 = ((Field) term8944).get((Object) null);
