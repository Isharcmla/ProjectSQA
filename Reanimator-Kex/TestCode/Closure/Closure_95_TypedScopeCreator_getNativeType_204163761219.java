...
public class TypedScopeCreator_getNativeType_204163761219 {
    ...
    public void setup() throws Throwable {
        ...
        Set<Object> term13166 =  ((Map) term4753).keySet();
        HashSet term4752 = new HashSet((Collection<? extends Object>) term13166);
        HashMap term4759 = new HashMap();
        Set<Object> term13167 =  ((Map) term4759).keySet();
        HashSet term4758 = new HashSet((Collection<? extends Object>) term13167);
        HashMap term4765 = new HashMap();
        Set<Object> term13168 =  ((Map) term4765).keySet();
        HashSet term4764 = new HashSet((Collection<? extends Object>) term13168);
        HashMap term4770 = new HashMap();
        HashMap term4775 = new HashMap();
        Class<? extends Object> term13180 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeRegistry$ResolveMode");
        Field term13179 = ((Class) term13180).getDeclaredField((String) "IMMEDIATE");
        ((Field) term13179).setAccessible(true);
        Object enum21 = ((Field) term13179).get((Object) null);
        ...
        Class<? extends Object> term13519 = Class.forName((String) "com.google.javascript.rhino.jstype.JSTypeNative");
        Field term13518 = ((Class) term13519).getDeclaredField((String) "NUMBER_STRING_BOOLEAN");
        ((Field) term13518).setAccessible(true);
        enum22 = ((Field) term13518).get((Object) null);
    }
