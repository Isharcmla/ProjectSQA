...
public class CodeGenerator_addNonEmptyStatement_42379450540 {
    ...
    public void setup() throws Throwable {
        ...
        Class<? extends Object> term5346 = Class.forName((String) "com.google.javascript.jscomp.CodeGenerator$Context");
        Field term5345 = ((Class) term5346).getDeclaredField((String) "START_OF_EXPR");
        ((Field) term5345).setAccessible(true);
        enum9 = ((Field) term5345).get((Object) null);
