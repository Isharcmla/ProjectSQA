...
public class DefaultPrettyPrinter_writeArrayValueSeparator_9307617850 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DefaultPrettyPrinter_writeArrayValueSeparator_9307617850() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "writeArrayValueSeparator", argTypes, null, args);
            assertTrue(false);
        }
