...
public class ParserMinimalBase_reportInputCoercion_92372986978 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ParserMinimalBase_reportInputCoercion_92372986978() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[2] = null;
        try {
            callMethod(klass, "_reportInputCoercion", argTypes, null, args);
            assertTrue(false);
        }
