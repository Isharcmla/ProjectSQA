...
public class FilteringParserDelegate_getBinaryValue_1290930922108 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public FilteringParserDelegate_getBinaryValue_1290930922108() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "getBinaryValue", argTypes, null, args);
            assertTrue(false);
        }
