...
public class DefaultPrettyPrinter_writeObjectEntrySeparator_108239448546 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DefaultPrettyPrinter_writeObjectEntrySeparator_108239448546() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "writeObjectEntrySeparator", argTypes, null, args);
            assertTrue(false);
        }
