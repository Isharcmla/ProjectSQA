...
public class DefaultPrettyPrinter_beforeObjectEntries_150216501444 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DefaultPrettyPrinter_beforeObjectEntries_150216501444() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "beforeObjectEntries", argTypes, null, args);
            assertTrue(false);
        }
