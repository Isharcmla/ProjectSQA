...
public class DefaultPrettyPrinter_writeRootValueSeparator_51720487142 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DefaultPrettyPrinter_writeRootValueSeparator_51720487142() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "writeRootValueSeparator", argTypes, null, args);
            assertTrue(false);
        }
