...
public class DefaultPrettyPrinter_beforeArrayValues_176520252848 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public DefaultPrettyPrinter_beforeArrayValues_176520252848() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "beforeArrayValues", argTypes, null, args);
            assertTrue(false);
        }
