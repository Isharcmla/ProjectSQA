...
public class ParserMinimalBase_reportInvalidEOFInValue_114187398183 {
    @Rule public Timeout globalTimeout = new Timeout(10, TimeUnit.SECONDS);

    public ParserMinimalBase_reportInvalidEOFInValue_114187398183() {
    }
    ...
    public void test() throws Throwable, Throwable {
        ...
        args[0] = null;
        try {
            callMethod(klass, "_reportInvalidEOFInValue", argTypes, null, args);
            assertTrue(false);
        }
